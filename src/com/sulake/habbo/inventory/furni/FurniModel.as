package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_235,this.onObjectPlaced);
         this._catalog = param7;
         this.var_557 = new Timer(const_1183,1);
         ...
         this.var_2239 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_235,this.onObjectPlaced);
               }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_353)
         {
         ...
         if(this.var_814 == null)
         {
            this.var_814 = this._windowManager.buildFromXML(this.var_2239) as IWindowContainer;
         }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_324);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_459.add(const_41,new Array());
         this.var_459.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_303;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_340 || _loc3_.category == FurniCategory.const_353 || _loc3_.category == FurniCategory.const_321)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1261 && param1.type == RoomEngineObjectEvent.const_235)
         {
            this.var_1261 = false;
         }
      }
      ...
      {
         return this.var_459.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_459.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_459.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
