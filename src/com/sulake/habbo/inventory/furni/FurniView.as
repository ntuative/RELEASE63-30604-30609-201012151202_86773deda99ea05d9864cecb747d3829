package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_863:int = 1;
      
      private const const_1543:int = 2;
      
      private const const_1545:int = 3;
      
      private const const_1542:int = 42;
      
      private const const_1544:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_437.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_437.add(FurniModel.const_45,new FurniGridView(this.var_62,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_437.getValue(this.var_367);
         if(_loc3_)
         {
      ...
      public function setViewToState() : void
      {
         ...
         if(this.var_2084 == _loc2_)
         {
            return;
         }
         this.var_2084 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_437.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_437.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_437.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_353)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_340)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_687 && this.var_687.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1544)
         {
            _loc3_ = this.const_1544;
         }
         else if(_loc3_ < this.const_1542)
         {
            _loc3_ = this.const_1542;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_345);
            }
         }
      }
   }
