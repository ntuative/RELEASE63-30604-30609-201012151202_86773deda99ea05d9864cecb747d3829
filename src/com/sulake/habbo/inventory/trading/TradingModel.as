package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1454:uint = 9;
      ...
      public static const const_291:uint = 3;
      
      public static const const_488:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_721 = true;
         this.state = const_168;
         this.var_49.setup(param1,param3,param4,param6);
         this.var_49.updateItemList(this.var_702);
         this.var_49.updateItemList(this.var_1347);
      ...
      public function close() : void
      {
         if(this.var_721)
         {
            if(this._state != const_177 && this._state != const_198)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_177;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1003);
            this.var_721 = false;
         }
      ...
      {
         this.var_49.setMinimized(param1 != InventoryCategory.const_75);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_703 + " OTHER: " + this.var_1095);
         ...
         {
            case const_177:
               if(param1 == const_168 || param1 == const_198)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_899);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_702)
            {
               this.var_703 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1095 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_702)
            {
               this.var_49.alertPopup(TradingView.const_946);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_277.length < const_1454)
         {
