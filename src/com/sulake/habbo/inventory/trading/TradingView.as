package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_824:uint = 4284532064;
      
      private static const const_823:uint = 2577770;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_355 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_173)
            {
               this.var_173.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_173.stop();
               this.var_173 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1447 = this.createMinimizedWindow();
         }
         if(!this.var_1947)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_824) : uint(const_823);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_824) : uint(const_823);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_173 = new Timer(1000,3);
            this.var_173.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_173.reset();
         this.var_173.repeatCount = 3;
         this.var_173.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_173.currentCount));
         if(this.var_173.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1085)
            {
            ...
            this.var_355.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_502);
            this.var_355.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_355.hideDelayed();
         }
      }
