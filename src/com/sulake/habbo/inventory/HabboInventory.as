package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_961:IRoomSession;
      ...
      private const const_1814:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_18 != null)
         {
            this.var_18.events.removeEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_467,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_44.getValue(InventoryCategory.const_75));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_44.getValue(InventorySubCategory.const_303));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_44.getValue(InventoryCategory.const_667));
      }
      ...
      {
         return AchievementsModel(this.var_44.getValue(InventoryCategory.const_381));
      }
      ...
      {
         return PetsModel(this.var_44.getValue(InventoryCategory.const_150));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_44.getValue(InventoryCategory.const_324) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_467,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_88:
               this.var_961 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_467:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_366 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_44.add(InventoryCategory.const_324,_loc1_);
         ...
         this.var_44.add(InventoryCategory.const_75,_loc2_);
         ...
         this.var_44.add(InventoryCategory.const_667,_loc4_);
         ...
         this.var_44.add(InventoryCategory.const_381,_loc5_);
         ...
         this.var_44.add(InventorySubCategory.const_303,_loc6_);
         ...
         this.var_44.add(InventoryCategory.const_150,_loc8_);
         this.var_172 = true;
         if(this.var_2004)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_303:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_784.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1814);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1045));
      }
