package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_39:
               this.var_1406.setSelectedGridItem(this);
               this.var_1405 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1405 = false;
                  this.var_1406.placePetToRoom(this.var_1230.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1809) : uint(this.const_1808);
      }
