package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1773 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER,RoomObjectTypeEnum.const_249,_loc3_.figure);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1773 && param1.type == RoomEngineObjectEvent.const_235)
         {
