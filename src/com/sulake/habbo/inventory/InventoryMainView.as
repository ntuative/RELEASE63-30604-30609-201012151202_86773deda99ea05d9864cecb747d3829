package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_1114)
         {
         ...
         this._controller.inventoryViewOpened(this.var_712);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_712);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1764);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_711 == InventoryCategory.const_150)
            {
               this.toggleCategoryView(InventoryCategory.const_150);
            }
            else if(this.var_711 == InventoryCategory.const_75)
            {
