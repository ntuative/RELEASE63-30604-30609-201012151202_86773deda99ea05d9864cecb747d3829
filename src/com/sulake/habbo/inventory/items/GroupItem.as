package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2628:BitmapData;
      
      private const const_1809:int = 8947848;
      
      private const const_1808:int = 13421772;
      
      private const const_1560:Number = 1;
      
      private const const_1559:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1388));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1884);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_764 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_1560;
               _loc1_.blend = this.const_1560;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1890 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2628;
               _loc5_.visible = true;
            }
            else
            {
