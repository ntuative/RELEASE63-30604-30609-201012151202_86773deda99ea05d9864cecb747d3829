package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1592:uint = 11129827;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1591 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_670)
         {
            this.var_670 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_670)
            {
               return;
            }
            this._window.content.addChild(this.var_670);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_669)
         {
            this.var_669 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_669)
            {
               return;
            }
            this._window.content.addChild(this.var_669);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_669.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_460;
         }
         this.showView(this.var_669);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_460);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_928 || param1 == ChangeUserNameResultMessageEvent.var_927)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_460 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_460);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_80);
         }
      }
