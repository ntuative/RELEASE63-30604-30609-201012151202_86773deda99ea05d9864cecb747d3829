   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_49)
         {
            ...
            this.var_46.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_531));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_645 = this.var_46.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_645.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_46.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU_ARROW,this.var_645));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_46.showView(TutorialUI.const_80);
               }
         }
      }
   }
