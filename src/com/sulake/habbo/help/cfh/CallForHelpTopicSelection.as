package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1132:int = 0;
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_631.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_631.length)
         {
            _loc8_ = this.var_631[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_631 == null || _loc3_ < 0 || _loc3_ >= this.var_631.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_631[_loc3_];
            main.showUI(HabboHelpViewEnum.const_659);
            main.tellUI(HabboHelpViewEnum.const_659,null);
         }
      }
   }
}
