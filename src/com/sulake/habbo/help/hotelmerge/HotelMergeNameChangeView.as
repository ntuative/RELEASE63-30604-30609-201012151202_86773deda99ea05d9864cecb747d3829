package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_670)
         {
            this.var_670 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_670)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_669)
         {
            this.var_669 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_669)
            {
               return;
            }
