      ...
      override public function render() : void
      {
         ...
         if(container != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               _loc1_.addEventListener(WindowKeyboardEvent.const_143,this.windowKeyEventProcessor);
               _loc1_.addEventListener(WindowEvent.const_166,this.onInputClick);
            }
