package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_304 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012151155));
         this._toolbar = param5;
         this.var_93 = new Map();
         this.var_93.add(HabboHelpViewEnum.const_1458,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_182,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_416,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_305,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_213,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_789,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_316,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_659,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_206,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_93.add(HabboHelpViewEnum.const_1001,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_93.add(HabboHelpViewEnum.const_927,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_817,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_457.length == 0 || param1 != this.var_304)
            {
               this.var_457.push(this.var_304);
            }
         }
         this.var_304 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_304);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_206:
               this.showUI(HabboHelpViewEnum.const_206);
               break;
            case CallForHelpResultEnum.const_1036:
               this.showUI(HabboHelpViewEnum.const_927);
               break;
            case CallForHelpResultEnum.const_1104:
               this.showUI(HabboHelpViewEnum.const_1001);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_93.getValue(HabboHelpViewEnum.const_182) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_431));
      }
      ...
      {
         return this.var_93.getValue(this.var_304);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1580 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1581;
         this._window.width = _loc1_.width + this.var_1580;
      }
      ...
      {
         if(this.var_457.length > 0)
         {
            this.showUI(this.var_457.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_304 == HabboHelpViewEnum.const_182)
         {
            return;
         }
         if(this.var_556.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_556.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_556.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_303.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_556[1],this.var_556[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_556[0],this.var_556[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_304 == HabboHelpViewEnum.const_182 || this.var_457.length == 0)
         {
            return;
         }
         if(this.var_303 == null)
         {
            ...
            this.var_303 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_303.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_303.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_303 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_303 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_303 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
