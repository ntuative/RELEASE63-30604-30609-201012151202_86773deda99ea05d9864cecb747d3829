package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_679:FaqCategory;
      ...
      {
         super();
         this.var_679 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_680 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_681 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_679.hasItem(param1))
         {
            this.var_679.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_679.hasItem(param1))
         {
            return this.var_679.getItem(param1);
         }
         if(this.var_680.hasItem(param1))
         {
