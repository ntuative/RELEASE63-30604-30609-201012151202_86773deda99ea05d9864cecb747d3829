package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2524 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1784)
            {
               if("false" == this._configuration.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_149,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_149,this.onLocalizationLoaded);
         if(this._configuration.keyExists("external.override.texts.txt"))
         {
            ...
            events.addEventListener(LocalizationEvent.const_149,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_149,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         return this.var_2524[Math.max(0,param1 - 1)];
      }
   }
}
