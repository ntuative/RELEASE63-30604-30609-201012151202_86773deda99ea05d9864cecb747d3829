package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_316:ICatalogNavigator;
      ...
      private var var_2382:GiftWrappingConfiguration;
      
      private var var_1063:ClubGiftController;
      
      private var var_472:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_196 == null)
            {
               this.var_196 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_196.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_472.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_316.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_108.getActivityPointsForType(Purse.const_534)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_735)
         {
            if(!this.var_366.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_317.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_316 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_317 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_317.habboCatalog = this;
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_472 == null)
         {
            this.var_472 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_316.buildCatalogIndex(_loc2_);
         if(this.var_695 && this.var_695 != "")
         {
            this.var_316.openPage(this.var_695);
            this.var_695 = "";
            this.var_848 = -1;
         }
         else if(this.var_848 > -1)
         {
            this.var_316.openPageById(this.var_848,this.var_1680);
            this.var_848 = -1;
            this.var_1680 = -1;
            this.var_695 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_317.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_317.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2384 && this.var_574 != null)
         {
            this.var_574.playSound(HabboSoundTypesEnum.const_951);
         }
         this.var_2384 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2383 && this.var_574 != null)
         {
            this.var_574.playSound(HabboSoundTypesEnum.const_938);
         }
         this.var_2383 = false;
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_317.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2382 = new GiftWrappingConfiguration(param1);
      }
