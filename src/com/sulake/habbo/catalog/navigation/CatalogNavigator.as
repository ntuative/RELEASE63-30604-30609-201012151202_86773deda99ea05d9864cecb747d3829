package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2679:String = "magic.credits";
      
      private var var_2638:String = "magic.pixels";
      
      private var var_2637:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2638);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2637,true);
      }
