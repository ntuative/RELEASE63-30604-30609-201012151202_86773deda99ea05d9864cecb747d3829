package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1596:String = "1.1";
      ...
      private var var_321:BitmapData = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1340[this.var_388];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1339[this.var_389];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1341[this.var_390];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1596);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_863[this.var_388];
         ...
         _loc6_ = this.var_1339[this.var_389];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_862[this.var_390];
         for each(_loc1_ in this._configuration.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1596 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1341[this.var_390];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_197:
               ...
               if(this.var_388 < 0)
               {
                  this.var_388 = this.var_863.length - 1;
               }
               if(this.var_388 == this.var_863.length)
               {
                  this.var_388 = 0;
               }
               this.var_391 = 0;
               this.var_864 = 0;
               _loc5_ = this.var_863[this.var_388];
               for each(_loc8_ in this._configuration.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_864 = _loc8_.children().length();
                  }
               }
            ...
            case const_93:
               ...
               if(this.var_390 < 0)
               {
                  this.var_390 = this.var_862.length - 1;
               }
               if(this.var_390 >= this.var_862.length)
               {
                  this.var_390 = 0;
               }
               this.var_477 = 0;
               this.var_866 = 0;
               _loc7_ = this.var_862[this.var_390];
               for each(_loc10_ in this._configuration.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_866 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1595,this.var_1596,64,this,"window_romantic_wide");
         ...
         {
            this.var_1716 = _loc2_.id;
            this.var_1717 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_322 != null && this.var_321 != null)
         {
            this.setRoomImage(this.var_322,this.var_321);
         }
      }
   }
}
