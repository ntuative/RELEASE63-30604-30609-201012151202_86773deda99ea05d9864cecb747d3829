package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      {
         this.var_843 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1060 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1667 = new Point(this.var_83.x,this.var_83.y);
         ...
         this.var_1668 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_843.text = _loc4_;
         this.var_1060.text = _loc5_;
         this.var_843.height = this.var_843.textHeight + 5;
         this.var_1060.y = this.var_843.y + this.var_843.height;
         this.var_1060.height = Math.max(130,this.var_1060.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_402:
                  _loc6_ = this.var_1668.clone();
                  if(this.var_471 != null)
                  {
                     this.var_471.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_471,this.var_1308,this.var_1468);
                     ...
                     case ProductTypeEnum.const_253:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_298,AvatarAction.const_526);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2364)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1667.x;
            this.var_83.y = this.var_1667.y;
            if(param3 != null)
            {
