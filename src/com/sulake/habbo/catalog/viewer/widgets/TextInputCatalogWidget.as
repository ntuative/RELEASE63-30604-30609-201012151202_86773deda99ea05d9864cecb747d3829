package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_987 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_987 != null)
         {
            this.var_987.addEventListener(WindowKeyboardEvent.const_595,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_987.text));
      }
   }
}
