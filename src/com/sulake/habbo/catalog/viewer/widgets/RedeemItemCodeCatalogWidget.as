package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1041.removeEventListener(WindowKeyboardEvent.const_143,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(this.var_1041 != null)
         {
            this.var_1041.addEventListener(WindowKeyboardEvent.const_143,this.windowKeyEventProcessor);
         }
      }
