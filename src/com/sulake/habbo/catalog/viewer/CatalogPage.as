package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1523:String = "ctlg_";
      ...
      private var var_956:ICatalogViewer;
      ...
      private var var_1229:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1228:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1229 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_989);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_989);
      }
      ...
      {
         var _loc2_:String = const_1523 + param1;
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1488) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1228 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1228);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1254) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1486) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1275) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1471) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1229;
            _loc2_.init();
         }
         this.var_1229.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1229.dispatchEvent(param1);
      }
   }
}
