package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_549:IWindowContainer;
      
      private var var_298:int = -1;
      
      private const const_1830:int = 10;
      ...
      private const const_1569:uint = 4.293848814E9;
      
      private const const_1570:uint = 4.294967295E9;
      
      private const const_1829:uint = 4.291613146E9;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_81.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_81.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_81 is Offer)
            {
               _loc10_ = this.var_81.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_81 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = this._catalog.getProductData(this.var_81.localizationId);
         ...
         var _loc8_:String = this.var_81.activityPointType == Purse.const_534 ? "pixels" : "activitypoints";
         switch(this.var_81.priceType)
         {
            case Offer.const_440:
               ...
               this._localization.registerParameter(_loc6_,"credits",this.var_81.priceInCredits.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_721:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits+activitypoints." + this.var_81.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,"credits",this.var_81.priceInCredits.toString());
               this._localization.registerParameter(_loc6_,_loc8_,this.var_81.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_81.activityPointType).toString());
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_604:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.activitypoints." + this.var_81.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,_loc8_,this.var_81.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_81.activityPointType).toString());
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1558 = _loc1_.stuffTypes;
            this.var_660 = _loc1_.boxTypes;
            this.var_659 = _loc1_.ribbonTypes;
            this.var_1001 = this.var_1558[0];
            this.var_299 = this.var_660[0];
            this.var_300 = this.var_659[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_300 < 0)
         {
            this.var_300 = this.var_659.length - 1;
         }
         if(this.var_300 > this.var_659.length - 1)
         {
            this.var_300 = 0;
         }
         if(this.var_299 < 0)
         {
            this.var_299 = this.var_660.length - 1;
         }
         if(this.var_299 > this.var_660.length - 1)
         {
            this.var_299 = 0;
         }
         var _loc1_:int = this.var_660[this.var_299] * 1000 + this.var_659[this.var_300];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_81.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1001,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1255 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1558;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1001);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_660[this.var_299]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_659[this.var_300]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_81,this.var_1254,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_81.offerId,this.var_1254);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_108:
               ...
               for each(_loc7_ in this.var_199)
               {
                  ...
                  if(_loc5_.length >= this.const_1830)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2185 = _loc3_.text;
               break;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_549 == null)
         {
            this.var_549 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_549.procedure = this.suggestionsEventHandler;
         }
         if(this.var_224 == null || this.var_549 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_549.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1829;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1569) : uint(this.const_1570);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1001;
               }
            }
            _loc4_++;
         }
