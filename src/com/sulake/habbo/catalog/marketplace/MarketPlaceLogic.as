package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1762:int = 1;
      
      public const const_1681:int = 2;
      
      public const const_1853:int = 3;
      ...
      private var var_2556:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_196)
         {
            this.var_196 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_196.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2553,this.var_2555,this.var_2253,this.var_2554);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1762,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2363 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1681,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_1972 || param1.furniTypeId != this.var_1974)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1164)
               {
                  _loc2_ = true;
               }
            }
