package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_839:int = 0;
      
      private static const const_387:int = 1;
      
      private static const const_840:int = 2;
      ...
      {
         return this.var_548 != const_839;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1551 != RecyclerStatusMessageEvent.const_1111;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_548 == const_387;
      }
      ...
      {
         this.var_548 = const_840;
         this.var_104 = new Array(const_165);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1551)
         {
            ...
            case RecyclerStatusMessageEvent.const_1111:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1500:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1009:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1495:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_104.length < const_165)
         {
            return false;
         }
         var _loc1_:int = 0;
