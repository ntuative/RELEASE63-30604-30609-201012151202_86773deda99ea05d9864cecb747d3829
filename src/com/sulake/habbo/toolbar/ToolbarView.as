package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1077:Number = 1;
      
      private var var_1329:Number = 0;
      
      private var var_1703:Number = 15;
      
      private var var_1704:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_198 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_1107,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1078 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1078)
         {
         ...
         this.var_1077 = _loc6_.toolbar.@margin_top;
         this.var_1329 = _loc6_.toolbar.@margin_bottom;
         this.var_1703 = _loc6_.toolbar.@min_group_margin;
         this.var_1704 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_235,param1,param2,this._window,this.var_261);
         this.createGroupsFromXmlList(_loc8_,this.var_575,param1,param2,this.var_198,this.var_261);
         this.alignWindows();
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_575.length)
         {
            _loc2_ = this.var_575[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_198.x = this.var_142 + this.var_1704;
               this.var_198.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_198.x = 0;
               this.var_198.y = this.var_142 + this.var_1704;
         ...
         _loc4_ -= this.var_1329;
         _loc4_ -= this.var_1077;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_235.length)
         {
            _loc3_ = this.var_235[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1077;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_235.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1703,(this._window.height - _loc5_ * _loc8_ - this.var_1077 - this.var_1329) / (this.var_235.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1703,(this._window.width - _loc5_ * _loc8_ - this.var_1077 - this.var_1329) / (this.var_235.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1078 && this.var_1328)
         {
