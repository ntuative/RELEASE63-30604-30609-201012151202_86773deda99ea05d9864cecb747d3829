package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1201:Number = 25;
      
      private static const const_1234:Number = 90;
      
      private static const const_854:int = 50;
      
      private static const const_1200:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1307:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_571 = new Object();
         this.var_570 = new Array();
         this.var_572 = new Array();
         super();
         this._windowManager = param1;
         this.var_1307 = param2;
         this.var_688 = new Timer(const_1201);
         this.var_688.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_311[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_854 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_854 || param1.desktop.height - param1.y < const_1200;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1307.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_311.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1307.getIconLoc(param1.iconId);
      ...
      {
         return this.var_570[this.var_572.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_572[this.var_570.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_572.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_572.splice(_loc3_,1);
            this.var_570.splice(_loc3_,1);
         }
         this.var_570.push(param1.name);
         this.var_572.push(param2);
         param1.addEventListener(WindowEvent.const_357,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_256,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_571[_loc3_] == null)
            {
               this.var_571[_loc3_] = new Array();
            }
            if(this.var_571[_loc3_].indexOf(param1) < 0)
            {
               this.var_571[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_311.indexOf(param1) > -1)
         {
            if(const_190)
            {
            ...
            else
            {
               ...
               this.var_311.splice(this.var_311.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_570.length)
         {
            if(this.var_570[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_571[_loc3_].length)
                  {
                     this.repositionWindow(this.var_571[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_311.length)
         {
            _loc2_ = this._itemList[this.var_311[_loc7_]];
            if(_loc2_.active)
            {
