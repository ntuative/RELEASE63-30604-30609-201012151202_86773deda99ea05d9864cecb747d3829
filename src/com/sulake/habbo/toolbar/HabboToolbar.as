package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1241:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1241 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1113,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_462,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_995,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_895,this.onHideWindowEvent);
         this._state = true;
