package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1213:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1214:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_708:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1089:AvatarEditorHandler;
      ...
      private var var_861:IFigureData;
      
      private var var_577:Dictionary;
      
      private var var_870:String = "M";
      
      private var var_1088:int = 0;
      
      private var var_1714:Boolean;
      
      private var var_1338:IHabboAvatarEditorDataSaver = null;
      
      private var var_1715:Boolean = false;
      
      private const const_1215:int = 2;
      ...
      private function init() : void
      {
         ...
         if(!this.var_172)
         {
            ...
            this.var_577["null"] = new FigureData(this);
            this.var_577["null"] = new FigureData(this);
            _loc1_ = this.var_577["null"];
            _loc2_ = this.var_577["null"];
            _loc1_.loadAvatarData(const_1213,FigureData.MALE);
            _loc2_.loadAvatarData(const_1214,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_475 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_626,new BodyModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_43,new HeadModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_207,new TorsoModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_618,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_1012,new HotLooksModel(this));
            this.var_475.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            this.var_475.add(AvatarEditorSideCategory.const_455,new ClubPromoModel(this));
            this.var_172 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_577[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_861.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_861.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_238 == null)
            {
               this.var_238 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_238.addChild(this._view.window);
               if(param5)
               {
                  this.var_238.center();
               }
            ...
            this.var_238.visible = !this.var_238.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_626);
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_708 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_861 = this.var_476.getFigureData(AvatarType.const_105);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1089 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_577[this.var_870];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1338 != null)
         {
            ...
            this.var_1338.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1714;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1088 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1215)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1416.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1154.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1366)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1088 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1154.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1088 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_475.getValue(AvatarEditorSideCategory.const_95);
      }
