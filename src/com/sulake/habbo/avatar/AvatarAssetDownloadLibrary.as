package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1770:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_1;
         this._assets = param4;
         this.var_891 = String(param1);
         this._revision = String(param2);
         this.var_1376 = param3 + this.var_891 + ".swf";
         ...
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_891 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_891);
            this._state = name_2;
         }
      }
      ...
      {
         var _loc1_:String = this.var_891;
