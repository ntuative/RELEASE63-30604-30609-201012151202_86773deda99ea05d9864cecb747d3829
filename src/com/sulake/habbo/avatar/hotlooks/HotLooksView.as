package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      public function init() : void
      {
         ...
         this.var_525 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_525.numGridItems > 0)
         {
            this.var_525.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_62 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_62.hotLooks)
         {
            ...
            this.var_525.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_525.getGridItemIndex(param2.parent);
