package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1846:String = "hd-99999-99999";
      ...
      private var var_334:PetDataManager;
      
      private var var_710:PaletteManager;
      
      private var var_584:String;
      
      private var var_279:Map;
      
      private var var_205:AvatarAssetDownloadManager;
      
      private var var_1763:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_584 = RenderMode.const_1408;
         ...
         this.var_96.add(AvatarType.const_105,_loc4_);
         ...
         this.var_96.add(AvatarType.const_63,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_334 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_710 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_334.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_205)
         {
            this.var_205.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_334.init();
         this.var_710.init();
         _loc2_ = this.var_96.getValue(AvatarType.const_105) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_96.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_96.getValue(AvatarType.const_105) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_955,this.onFigureDataDownloadDone);
               if(this.var_205 == null)
               {
                  ...
                  this.var_205 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_205.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_818)
         {
            if(this.var_2508 && this.var_2510 && this.var_2509)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_205.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_205.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_96.getValue(AvatarType.const_105) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_205.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1763)
         {
            this.var_1763 = new AvatarFigureContainer(this.const_1846);
         }
         this.var_205.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1763,param2);
      }
      
      public function include(param1:IPetImageListener) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:int = 0;
         ...
         for each(_loc3_ in this.var_279.getKeys())
         {
            _loc4_ = this.var_279.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1314)
         {
            _loc6_ = !this.var_334.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_334.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_96.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_279.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_334.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_96.getValue(AvatarType.const_63);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_279.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_279.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_96.getValue(AvatarType.const_105) as AvatarStructure;
      ...
      {
         return this.var_334 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_63:
               _loc3_ = this.var_96.getValue(AvatarType.const_63) as AvatarStructure;
               break;
            default:
