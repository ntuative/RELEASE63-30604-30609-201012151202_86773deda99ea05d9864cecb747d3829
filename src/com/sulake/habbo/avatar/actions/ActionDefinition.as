package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2010 = parseInt(param1.@precedence);
         this.var_2011 = String(param1.@activepartset);
         this.var_2007 = String(param1.@assetpartdefinition);
         this.var_2009 = String(param1.@lay);
         this.var_733 = String(param1.@geometrytype);
         this.var_2005 = Boolean(parseInt(param1.@main));
         this.var_2008 = Boolean(parseInt(param1.@var_2337));
         this.var_2012 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            {
               this.var_1483[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_364[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_638.add(param1,new Map());
         }
         var _loc4_:Map = this.var_638.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_638.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1483[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2006;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_364[param1];
         if(_loc2_ != null)
         {
