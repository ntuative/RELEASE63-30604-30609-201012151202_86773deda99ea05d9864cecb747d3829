package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1520 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2103 = parseInt(_loc2_,16);
         this.var_2105 = parseInt(_loc3_,16);
         ...
         this.var_1470 = new ColorTransform(this.var_1639,this.var_1640,this.var_1641,this._alphaMultiplier);
         this.var_988 = this.generatePaletteMapForGrayscale(this.var_2105,this.var_2103);
      }
      ...
      {
         return this.var_988.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_988.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_988.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_988.getValue("alphas") as Array;
      }
