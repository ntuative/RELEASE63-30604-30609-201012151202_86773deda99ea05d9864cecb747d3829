package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_392.getValue(_loc4_) == null)
               {
                  this.var_392.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         var _loc3_:IPetData = this.var_392.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_392.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_392.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_392.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_79)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1354.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_581.getValue(_loc6_) == null)
               {
                  ...
                  this.var_581.add(_loc6_,_loc8_);
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_581.getKeys())
         {
            _loc5_ = this.var_581.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
