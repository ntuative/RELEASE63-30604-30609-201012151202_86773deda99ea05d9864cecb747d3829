package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_247:AvatarImageCache;
      
      private var var_563:int = 0;
      
      private var var_1626:int = 0;
      
      private var var_579:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_579 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_579.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1385 = this.var_1384;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_43)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1385);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_563);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_579,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1385 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_79)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_563);
                  _loc20_ = this.var_85;
                  _loc21_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_563);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_579,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_79)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_563);
                  _loc21_ = this.var_85;
                  _loc22_ = 1;
                  switch(this.var_85)
                  {
      ...
      private function sortActions() : void
      {
         ...
         this.var_1386 = this._structure.sortActions(this.var_287);
         ...
         {
            this.var_638 = this._structure.getCanvasOffsets(this.var_1386,this._scale,this.var_85);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1386)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_334)
               {
                  this.var_894 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1384 = _loc4_.id;
                     this.var_1787 = _loc4_.breed;
                     break;
                  }
               }
            }
