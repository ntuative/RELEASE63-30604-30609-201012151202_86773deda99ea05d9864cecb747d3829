package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1154:IWindowContainer;
      
      public static var var_1416:IWindowContainer;
      
      public static var var_1872:int = 6710886;
      ...
      private var var_417:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_416:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_942 = [];
         this.var_1184 = [AvatarEditorFigureCategory.const_626,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_207,AvatarEditorFigureCategory.const_618,AvatarEditorFigureCategory.const_1012,AvatarEditorFigureCategory.const_95];
         super();
         ...
         if(var_1154 == null)
         {
            ...
            var_1154 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1416 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1416 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_352 = new Timer(1000);
         this.var_352.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1184;
         }
         for each(_loc6_ in param4)
         {
            this.var_942.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_352.stop();
            this.var_352.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_352 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1184);
         }
         if(param1.length != this.var_942.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_942.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_1910 = this.canChangeOutfit();
            this.var_352.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_417 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_417.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_417.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_942.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_417.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_417.numSelectables)
               {
                  this.var_417.getSelectableAt(_loc6_).x = this.var_417.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1184;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1431 == AvatarEditorSideCategory.const_95 || this.var_1908))
         {
         ...
         this.setViewToCategory(this.var_304);
      }
      ...
      {
         if(this.var_1431 == AvatarEditorSideCategory.const_95)
         {
            this.var_1908 = false;
            this.setSideContent(AvatarEditorSideCategory.const_780);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_780:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_304 = param1;
         this.var_417.setSelected(this.var_417.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_416)
         {
            ...
            this.var_416 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_416.procedure = this.stripClubDialogEventProc;
            this.var_416.center();
         }
         else
         {
