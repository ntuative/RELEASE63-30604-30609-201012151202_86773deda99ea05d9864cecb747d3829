package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1198:String = "Default";
      
      private static const const_1199:int = 2;
      
      private static const const_1197:String = AvatarSetType.const_32;
      ...
      protected var var_720:Boolean;
      
      protected var var_638:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_247:AvatarImageCache;
      
      protected var var_579:AvatarFigureContainer;
      ...
      private var var_2323:String = null;
      
      private var var_2324:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_579 = param3;
         this.var_247 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1197,const_1199);
         this.var_287 = new Array();
         this.var_895 = new ActiveActionData(AvatarAction.const_315);
         this.var_895.definition = this._structure.getActionDefinition(const_1198);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_579,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1626;
         if(param2 < AvatarDirectionAngle.const_968)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_563,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_273.length == 1 && this.var_85 == this.var_1887)
         {
            return this.var_85 + this.var_466 + this.var_563 % 4;
         }
         if(this.var_273.length == 2)
         {
            for each(_loc1_ in this.var_273)
            {
               ...
               {
                  return this.var_85 + this.var_466 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_563 % 11;
                  return this.var_85 + "_" + this.var_1887 + this.var_466 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2322 || param2 != this.var_2323 || param1 != this.var_2324)
         {
            this.var_2322 = param3;
            this.var_2323 = param2;
            this.var_2324 = param1;
            this.var_1625 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1166 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1166)
            {
               this.var_39.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_252.definition.geometryType,this.var_85);
         this.var_39.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_563);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_252.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_563);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_563));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_252 = this.var_895;
         this.var_252.definition = this.var_895.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_466 = "";
         this.var_273 = this._structure.sortActions(this.var_287);
         if(this.var_273 == null)
         {
            this.var_638 = new Array(0,0,0);
            if(this.var_1287 != "")
            {
               _loc1_ = true;
               this.var_1287 = "";
         ...
         {
            this.var_638 = this._structure.getCanvasOffsets(this.var_273,this._scale,this.var_85);
            for each(_loc4_ in this.var_273)
            {
               ...
               if(_loc4_.actionType == AvatarAction.const_302)
               {
                  ...
                  if(this.var_1288 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1288 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1287 != this.var_466)
            {
               _loc1_ = true;
               this.var_1287 = this.var_466;
            }
         }
         this.var_1286 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1626 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_264 || _loc1_.actionType == AvatarAction.const_222 || _loc1_.actionType == AvatarAction.const_334)
               {
                  this.var_894 = true;
               }
            }
