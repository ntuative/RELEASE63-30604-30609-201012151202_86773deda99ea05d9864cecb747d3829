package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1224:String = "pixelbalance";
      
      private static const const_1225:String = "badges";
      
      private static const const_1226:String = "selectbadge";
      
      private static const const_1223:String = "inventory";
      
      private static const const_1221:String = "selectfurni";
      
      private static const const_1227:String = "credits";
      
      private static const const_1222:String = "friendlist";
      
      private static const const_1228:String = "pet_inventory";
      ...
      private var var_717:IHabboToolbar;
      ...
      private var var_716:ParkBusDialogManager;
      
      private var var_2512:Boolean;
      
      private var var_888:ClubGiftNotification;
      
      private var var_887:ClubEndingNotification;
      
      private var var_886:ClubPromoNotification;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_717)
         {
            this.var_717.release(new IIDHabboToolbar());
            this.var_717 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         this.var_1117.push(_loc8_);
         return this.var_1117.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1117.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_206 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_717 = IHabboToolbar(param2);
         this.var_717.events.addEventListener(HabboToolbarEvent.const_74,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_74)
         {
            ...
            this.var_490 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_885["styles"],this.var_885["view"],this.var_717);
            ...
            this.var_366.events.addEventListener(BadgeImageReadyEvent.const_121,this.onBadgeImage);
            this.var_717.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1373[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_366);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1373[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1373[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1317);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_366.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1061);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1061);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1267);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_476.createAvatarImage(param2,AvatarScaleType.const_46);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_366.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_78)
               {
                  _loc9_ = this.var_366.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_366.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1497,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1009)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1482);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1395)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_887 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_886 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         if(this.var_490.isSpaceAvailable() && this.var_1117.length > 0)
         {
            this.var_490.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_340;
            }
            if(param2 == 4057)
            {
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_206 == null)
         {
            return;
         }
         this.var_206.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_206.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_206.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_206.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_206.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_716 == null)
         {
            this.var_716 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_716 != null)
         {
            this.var_716.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_476.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1067,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_476.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2512)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1017);
            this.var_2512 = true;
      ...
      {
         if(param2.type == WindowEvent.const_185 || param2.type == WindowEvent.const_777)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1017,_loc6_);
      }
   }
}
