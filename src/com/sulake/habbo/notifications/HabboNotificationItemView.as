package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_562:int = 70;
      
      public static const const_420:int = 4;
      
      private static const name_1:int = 0;
      
      private static const const_525:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1510 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1510 = 15;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_525:
               this.var_980 += param1;
               _loc2_ = Number(this.var_980) / Number(this.var_365["time_fade_in"]);
               if(this.var_980 > int(this.var_365["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_832:
               ...
               if(this.var_1223 > int(this.var_365["time_display"]) && !this.var_1511)
               {
                  this.startFadeOut();
               }
               break;
            case const_833:
               this.var_981 += param1;
               _loc3_ = 1 - Number(this.var_981) / Number(this.var_365["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_981 > int(this.var_365["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1510;
         if(this._window.height < this.var_1512)
         {
            this._window.height = this.var_1512;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_365["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_420;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_420;
            }
         }
         else if(this.var_365["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_420;
         }
         else
         ...
         if(this.var_365["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_648;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_648;
            }
         }
         else if(this.var_365["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_648;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_649;
      }
   }
}
