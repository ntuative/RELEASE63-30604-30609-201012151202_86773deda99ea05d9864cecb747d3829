package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1541:String = "badge_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2077 = this._localizations.getBadgeName(this.var_263);
         this.var_2083 = this._localizations.getBadgeDesc(this.var_263);
         this.var_2081 = this._localizations.getAchievementNameForFacebook(this.var_263,this.var_366.userName,this.var_366.realName,this.var_1224);
         this.var_2082 = this._localizations.getAchievementDescForFacebook(this.var_263,this.var_366.userName,this.var_366.realName,this.var_1224);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2079 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1429.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1225.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1225.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1514;
         var _loc17_:String = this.var_1514 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_2080);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1541);
         ...
         if(this.var_1225 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_263,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_263,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_263,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2077);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2083);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2081);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2082);
         this._localizations.registerParameter(param1,"level",this.var_1224.toString());
         this._localizations.registerParameter(param1,"name",this.var_366.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_366.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_366.events.removeEventListener(BadgeImageReadyEvent.const_121,this.onBadgeImageReady);
            this.var_366 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_263)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1541);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_263,this._feedTitleFb,this.var_2079,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2078));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_263,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_263,"client.skip_post"));
               this.dispose();
               return;
         }
      }
