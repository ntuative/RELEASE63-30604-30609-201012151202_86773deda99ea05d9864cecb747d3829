package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1992,this.var_365,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_562 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         {
            _loc3_ = this.var_187[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_562 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_562 + const_545;
            _loc2_++;
         }
         return _loc1_;
      }
