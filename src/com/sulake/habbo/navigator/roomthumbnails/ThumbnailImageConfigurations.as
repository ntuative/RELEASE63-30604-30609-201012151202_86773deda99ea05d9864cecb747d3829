package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      public function ThumbnailImageConfigurations(param1:HabboNavigator)
      {
         ...
         this.var_1780 = this._navigator.getButtonImage("rico_selected");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(this._navigator,param1,param2,param3,this.var_1780);
      ...
      {
         var _loc2_:Dictionary = this.var_1575[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1575[param1] = _loc2_;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:Array = this.var_1576[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Array();
