package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2125 = new RoomThumbnailRenderer(param1);
         this.var_1080 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_158,this.var_103);
         if(this.var_103.ownerName != "" && this.var_103.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_158,!!this.var_103.event ? this.getEventCtg(this.var_103.categoryId) : this.getRoomCtg(this.var_103.categoryId));
         this.refreshRoomDesc(this.var_158,this.var_103);
         this.refreshExtraCont();
         this.refreshInfo(this.var_158,"trading_allowed",this.var_103.allowTrading);
         this.refreshInfo(this.var_158,"doormode_doorbell",this.var_103.doorMode == 1);
         this.refreshInfo(this.var_158,"doormode_password",this.var_103.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_158,this.var_103.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1080.refreshTags(_loc1_,this.var_103.tags);
         ...
         this.var_2125.refreshThumbnail(_loc1_,this.var_103.thumbnail,false);
