package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1108:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,104,"a"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,94,"b"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,36,"c"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,84,"d"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,80,"e"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,80,"f"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,416,"i"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,320,"j"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,448,"k"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,352,"l"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,384,"m"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_48,372,"n"));
         ...
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,540,"t"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,512,"w"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,396,"x"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,440,"y"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,456,"z"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_51,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1108.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1735 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1735 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_163 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_53 = IItemListWindow(this.var_163.findChildByName("item_list"));
         this.refreshRoomThumbnails();
         Util.setProcDirectly(this.getCreateButton(),this.method_4);
         Util.setProcDirectly(this.getCancelButton(),this.onCancelButtonClick);
         var _loc1_:IWindow = this.var_163.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_1107 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_163.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_163.desktop,this.var_163.width,this.var_163.height);
         this.var_163.x = _loc2_.x;
         this.var_163.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_1107.goBackToInitialState();
         this.var_1107.input.textBackgroundColor = 4294967295;
         this.var_1108 = this.var_38[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_1107.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
         return Boolean(_loc1_);
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_163.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_163.findChildByName("back_button"));
      }
      ...
      private function method_4(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1107.getText();
         var _loc4_:String = "model_" + this.var_1108.name;
