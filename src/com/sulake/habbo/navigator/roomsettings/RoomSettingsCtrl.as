package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_380:IRoomSettingsCtrlOwner;
      ...
      private var var_2337:ITextWindow;
      
      private var var_1633:ITextWindow;
      ...
      {
         this.var_309 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_309));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1631 = true;
         this.var_380.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_309 || this.var_1042 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1042 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1449)
         {
            this.var_684.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1517)
         {
            this.var_684.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1433)
         {
            this.var_1050.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1440)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_454,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_804,this.onDoorModePasswordUnselect);
         ...
         this.var_835 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_836 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_837 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1047 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1044 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1048 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1049 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_565 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1634 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1291 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1043 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1046 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1632 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1045 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2336 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2337 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1633 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1633.procedure = this.onSwitchView;
         this.var_1045.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1634.visible = this._inRoom;
         this.var_1632.visible = this._inRoom;
         this.var_2337.visible = this.var_467;
         this.var_2336.visible = !this.var_467;
         if(this.var_467)
         {
         ...
         else
         {
            ...
            this.var_1291.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1291.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1043.height = Util.getLowestPoint(this.var_1043) + 4;
         }
         this.var_1633.text = !!this.var_467 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1634.name,this.var_1291.name,this.var_1043.name,this.var_1046.name,this.var_1292.name,this.var_1632.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.setTag(this.var_835,_loc1_.tags[0]);
         this.setTag(this.var_836,_loc1_.tags[1]);
         if(this.var_1044)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_110)
         {
            ...
            _loc9_ = this.var_1047.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_837.clearErrors();
               this.var_1047.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1044.isSelected;
         _loc2_.allowFoodConsume = this.var_1048.isSelected;
         _loc2_.allowWalkThrough = this.var_1049.isSelected;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_309);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_73.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_309]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_229.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_229.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_229.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_229.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_229.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_229.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_229.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_229);
         this.var_229.findChildByName("ruler").visible = true;
         ...
         if(this.var_73.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_229,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_309));
      }
