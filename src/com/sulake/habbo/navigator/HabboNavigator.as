package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_544:RoomInfoViewCtrl;
      
      private var var_996:RoomCreateViewCtrl;
      ...
      private var var_2683:Dictionary;
      ...
      private var var_2125:RoomThumbnailRenderer;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_544 = new RoomInfoViewCtrl(this);
         this.var_996 = new RoomCreateViewCtrl(this);
         this.var_2125 = new RoomThumbnailRenderer(this);
         this.var_837 = new GuestRoomPasswordInput(this);
         this.var_336 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_308,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_544.registerToolbarEvents();
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_266.startSearch(Tabs.const_216,Tabs.const_328,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_266.startSearch(Tabs.const_292,Tabs.const_209);
         this.var_398.getTab(Tabs.const_292).tabPageDecorator.tabSelected();
      }
