package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1157:int = 267;
      
      private static const const_1159:int = 65;
      
      private static const const_1158:int = -70;
      ...
      private var var_2156:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2156 = new PublicRoomThumbs();
         super();
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_610 || param2.type == OfficialRoomEntryData.const_602))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1159) : int(const_1157);
      ...
      {
         var _loc4_:String = this.var_2156.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1158) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_328,_loc2_.tag);
         }
