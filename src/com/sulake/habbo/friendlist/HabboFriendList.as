package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_978)
         {
            this.var_978.release(new IIDAvatarRenderManager());
            this.var_978 = null;
         }
         if(this.var_780)
         {
            this.var_780.release(new IIDHabboNotifications());
            this.var_780 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_708)
         {
            this.var_708.release(new IIDSessionDataManager());
            this.var_708 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1741 = new OpenedToWebPopup(this);
         }
         this.var_1741.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_86);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_332.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_308,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_978.createAvatarImage(param1,AvatarScaleType.const_79,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_978 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_780 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_332 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1090,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_363,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_363);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_342));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_332.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_332.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_398.findTab(FriendListTab.const_90).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_332.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_398.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1740.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_398.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_708 || !this.var_332)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_708.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_332.vipLimit;
         }
         else if(this.var_708.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_332.clubLimit;
         }
         if(_loc2_ > this.var_332.limit)
         {
            this.var_332.limit = _loc2_;
         }
      }
