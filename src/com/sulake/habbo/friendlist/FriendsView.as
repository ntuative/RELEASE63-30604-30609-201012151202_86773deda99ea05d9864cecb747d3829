package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_627:String = "bg";
      ...
      private var var_2069:IContainerButtonWindow;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_355 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2071 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2072 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2070 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2069 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_86).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_627);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_86,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_627);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_86,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2071,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2072,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2070,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2069,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_355.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_86,param4);
         _loc6_.visible = true;
      }
