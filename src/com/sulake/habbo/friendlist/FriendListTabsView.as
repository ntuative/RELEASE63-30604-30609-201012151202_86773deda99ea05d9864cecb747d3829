package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_163.width = this._friendList.tabs.tabContentWidth;
         this.var_163.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_163.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_163.height = _loc2_ + 1;
         this.var_163.findChildByName("bg").height = this.var_163.height;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_342);
         }
      }
