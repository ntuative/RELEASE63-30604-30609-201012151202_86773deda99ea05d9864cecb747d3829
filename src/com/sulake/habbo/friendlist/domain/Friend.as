package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_870 = param1.gender;
         this.var_634 = param1.online;
         this.var_1432 = param1.followingAllowed && param1.online;
         this.var_579 = param1.figure;
         this.var_1489 = param1.motto;
         this.var_1457 = param1.lastAccess;
         this.var_1189 = param1.categoryId;
         this.var_1458 = param1.realName;
