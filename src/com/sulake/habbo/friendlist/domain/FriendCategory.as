package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_351:int = 100;
      
      public static const const_1090:int = 0;
      ...
      {
         if(this.var_857 >= this.getPageCount())
         {
            this.var_857 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_199.length / const_351);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_857 * const_351;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_857 + 1) * const_351,this.var_199.length);
      }
