package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1535:String = "noconvinfo";
      
      private static const const_1534:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1202:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1202 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_910 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_239 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1202.prepare(this.var_910);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_971,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1064,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_761,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_701,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_761,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_701,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1203 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1203.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1462 == -1 ? 0 : int(this.var_17.height - this.var_1462);
         var _loc4_:int = this.var_1463 == -1 ? 0 : int(this.var_17.width - this.var_1463);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_239.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_1461 = false;
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_733,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_959,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_761,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_971,false);
         ...
         this.var_1462 = this.var_17.height;
         this.var_1463 = this.var_17.width;
