package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_384 = new Timer(500,1);
         this.var_312 = new Timer(100,1);
         super();
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._friendList.getXmlWindow(this.var_1248));
         ...
         this.var_48.x = _loc4_.x - _loc3_.x + this.var_2226 + param2.width;
