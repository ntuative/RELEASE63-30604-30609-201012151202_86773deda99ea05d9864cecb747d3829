package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1179:int = 40;
      
      private static const const_1552:int = 5;
      
      private static const const_1178:int = 20;
      ...
      private var var_429:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1011 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2216 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_811 = new Timer(1000,1);
         this.var_811.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_1012 = new Timer(5000,1);
         this.var_1012.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_143,this.windowKeyEventProcessor);
         ...
         this._window.addEventListener(WindowEvent.const_357,this.onWindowMoved);
         this.var_1582 = true;
         this.var_458 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2215 = _loc2_.width + const_843 + _loc6_.width + const_1178;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1179,_loc8_.width) + const_843);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_429 = param1 - this.var_2215;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_429);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_429);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1011 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_458 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_810);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_429)
         {
