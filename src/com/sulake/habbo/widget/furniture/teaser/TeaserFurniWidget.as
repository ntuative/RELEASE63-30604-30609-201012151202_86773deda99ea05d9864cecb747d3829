package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1558:int = 0;
      ...
      private const const_1836:int = 0;
      
      private const const_1833:int = 1;
      
      private const const_1832:int = 2;
      
      private const const_1834:String = "xmas10_dialog_bg_png";
      
      private const const_1557:String = "xmas10_dialog_telepair_png";
      
      private const const_1186:String = "xmas10_present_dialog_img_png";
      
      private const const_1835:String = "xmas10_dialog_newbiegift_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_652,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_767,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_538:
               _loc2_ = this.const_1558;
               this.var_1265 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_767:
               ...
               this.var_1265 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_652:
               _loc2_ = this.const_1555;
               this.var_325 = param1.objectId;
               this.var_1265 = param1.data;
         ...
         if(this.var_1266 != _loc2_ && this._window)
         {
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            ...
            if(_loc4_)
            {
               _loc3_ = (assets.getAssetByName(this.const_1834) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_717);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1265,_loc4_);
         this.hideInterface();
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_794,"ViralGift",param1,param2,param3);
