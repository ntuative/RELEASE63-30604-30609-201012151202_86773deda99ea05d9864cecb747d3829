package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_883:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_426 = param1.volume;
         if(this.var_883 != null)
         {
            this.var_883.setValue(this.var_426);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1757 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1755 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1756 = (_loc5_.content as BitmapData).clone();
         }
         this.var_883 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_426 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1757);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1755);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_426 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1758);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1756);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_792);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_749);
         }
