package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      public function EffectView()
      {
         ...
         this.var_173.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_173.stop();
            this.var_173.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_173 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_915 != null)
         {
            if(this.var_169.isActive)
            {
               ...
               this.var_915.width = _loc2_ * this.var_429;
            }
            else
            {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_917.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_917.text;
            if(this.var_169.isActive)
            {
               ...
               this.var_917.text = _loc1_;
            }
            else
            {
               this.var_917.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_916 = this._window.findChildByName("effect_hilite");
            this.var_916.visible = false;
         }
         this.var_917 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_915 = this._window.findChildByName("loader_bar");
         if(this.var_915 != null)
         {
            this.var_429 = this.var_915.width;
            this.var_173.start();
            this.onUpdate();
         }
