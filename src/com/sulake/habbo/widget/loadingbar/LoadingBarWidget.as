package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_451:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_451.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_451 = null;
         }
         if(this.var_39 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_451 == null)
         {
            ...
            this.var_451.addChild(new Bitmap(this.var_39));
            this.var_451.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_451.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_451);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1177 != "")
         {
            HabboWebTools.openWebPage(this.var_1177);
         }
      }
   }
}
