package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_125,this.showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_61,this.showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_119,this.showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_125,this.showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_61,this.showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_119,this.showPollContent);
      }
