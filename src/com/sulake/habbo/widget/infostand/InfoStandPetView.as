package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1819:int = 158;
      
      private const const_1820:int = 16;
      
      private const const_1821:uint = 11184810;
      
      private const const_1827:uint = 6710886;
      
      private const const_1826:uint = 3355443;
      
      private const const_1822:String = "level";
      
      private const const_1823:String = "experience";
      
      private const const_1824:String = "energy";
      
      private const const_1825:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_200 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_200.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_200.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_200.width < this.var_63.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1822,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1823,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1824,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1825,param1.nutrition,param1.method_1);
         ...
         this.var_1230.remove(param1.id);
         this.var_1230.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1819,this.const_1820,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1821);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1826);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1827);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1230.getValue(this.var_539) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_50 = this.var_200.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_175 && this.var_175.getPetId() == this.var_539)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_514,this._widget.petData.ownerId);
