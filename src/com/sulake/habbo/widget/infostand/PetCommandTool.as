package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1818:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_369 = new Timer(this.const_1818);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = this.var_982.getValue(param1) as Array;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:Array = this.var_982.getValue(this.var_539) as Array;
      ...
      {
         this.var_982.remove(param1);
         this.var_982.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_573,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.setParamFlag(WindowParam.const_92,true);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_368 == null)
         {
            ...
            this.var_368 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_368 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_368.x = 200;
            this.var_368.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_349,this.var_539));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_814,this.var_539,this.var_2092 + " " + _loc6_);
