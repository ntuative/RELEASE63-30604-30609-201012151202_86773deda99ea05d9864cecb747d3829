package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_136:Function;
      
      private var _offsetX:int;
      
      private var var_973:int;
      
      private var var_974:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_973 = 0;
         this.var_974 = param2.rectangle.clone();
         this.var_974.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_974.width)
         {
            return false;
         }
         if(this.var_973 + param1.height > this.var_974.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_974.width)
         {
            this._offsetX = 0;
            this.var_973 += param1.height + this.const_1816;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_973);
         this._offsetX += param1.width + this.const_1815;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1217 != null && this.var_1217.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_136);
