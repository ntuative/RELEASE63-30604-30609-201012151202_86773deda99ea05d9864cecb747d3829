package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_881:uint = 11;
      ...
      private var var_1141:IHabboWindowManager;
      ...
      private var var_610:LagWarningLogger = null;
      
      private var var_609:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_610 = new LagWarningLogger();
         this.var_609 = new ToolbarClickTracker(this);
         this.var_1403 = new Array(const_881);
         var _loc4_:int = 0;
         while(_loc4_ < const_881)
         {
            this.var_1403[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1343,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1509,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1334,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_793,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1097,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1141)
            {
               this.var_1141.release(new IIDHabboWindowManager());
               this.var_1141 = null;
            }
            if(this.var_282)
            {
            ...
            if(this.var_185)
            {
               if(!this.var_185.disposed)
               {
                  ...
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.const_342,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_157)
            {
               ...
               {
                  this.var_157.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_157.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_157.release(new IIDHabboHelp());
               this.var_157 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_149);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_748,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_210,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_180,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_771,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_610 != null)
            {
               this.var_610.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_771)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1510);
         }
         else if(param1.type == HabboHotelViewEvent.const_444)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1263);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1281);
               break;
            case HabboCommunicationEvent.const_748:
               this.trackLoginStep(HabboLoginTrackingStep.const_1508,String(this._communication.port));
               break;
      ...
      {
         this.var_1141 = IHabboWindowManager(param2);
         if(this.var_1141)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1403)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_921);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_921,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.const_342,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_342:
      ...
      {
         this.var_157 = param2 as IHabboHelp;
         this.var_157.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_157.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2587)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1284);
            this.var_2587 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1097,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_793,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_282.events.addEventListener(AdEvent.const_491,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_609)
         {
            this.var_609.track(param1.iconName);
         }
      }
      ...
      {
         this.var_610.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_608 != null)
         {
            this.var_608.trackUpdate(param1,this,this.var_499);
         }
         if(this.var_610 != null)
         {
            this.var_610.update(this.var_499);
         }
      }
   }
}
