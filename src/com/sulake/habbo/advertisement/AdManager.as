package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1145:BitmapData = null;
      
      private var var_1147:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2589 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2592 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2590 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1146 == 0)
         {
            this.var_1146 = getTimer();
            return false;
         }
         if(this.var_1831 > 0 && this.var_1830 >= this.var_1831)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1146;
         if(_loc1_ > this.var_2592)
         {
            ++this.var_1830;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1408 = _loc2_.imageUrl;
         this.var_2591 = _loc2_.clickUrl;
         this.var_1146 = getTimer();
         if(this.var_1408 != "")
         {
            _loc3_ = this.var_1408;
            ...
            {
               this.var_211 = new Timer(this.var_2590,1);
            ...
            this.var_211.start();
            _loc4_ = new URLRequest(this.var_1408);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_445,0,0,param1.bitmapData,this.var_2591));
            this.var_1146 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_421));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1407 = _loc2_.imageUrl;
         this.var_1832 = _loc2_.clickUrl;
         if(this.var_1407 != "" && this.var_1832 != "")
         {
            _loc3_ = this.var_1407;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1407);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_491,0,0,_loc4_,this.var_1832,this.var_1145,this.var_1147));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1145 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1147 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
