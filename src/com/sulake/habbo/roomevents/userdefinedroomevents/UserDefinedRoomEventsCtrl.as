package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1567:TriggerConfs;
      
      private var var_1569:ActionTypes;
      
      private var var_1568:ConditionTypes;
      
      private var var_225:Dictionary;
      
      private var var_58:Triggerable;
      
      private var var_666:RoomObjectHightLighter;
      
      private var var_157:UserDefinedRoomEventsHelp;
      
      private var var_1006:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1567 = new TriggerConfs();
         this.var_1569 = new ActionTypes();
         this.var_1568 = new ConditionTypes();
         this.var_225 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_666 = new RoomObjectHightLighter(param1);
         this.var_157 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1006 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1006.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1006.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_666.hideAll(this.var_225);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_666.showAll(this.var_225);
         if(this.var_58 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_58);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1006.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1006.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_157.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1567);
         this.refreshConfigureElement(this.var_1569);
         this.refreshConfigureElement(this.var_1568);
