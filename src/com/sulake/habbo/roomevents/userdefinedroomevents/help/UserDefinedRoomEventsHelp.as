package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1086:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1713 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1086 = this.var_1713.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1086)
         {
            this.var_1086.procedure = this.onButtonClick;
         }
         this.var_1085 = this.var_1713.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1085)
         {
      ...
      {
         if(this.var_237 >= this._localizations.length - 1)
         {
         ...
         if(this.var_237 <= 0)
         {
            this.var_1086.disable();
         }
         else
         {
            this.var_1086.enable();
         }
      }
      ...
      {
         ++this.var_237;
         this.var_237 = Math.min(this.var_237,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_237;
         this.var_237 = Math.max(this.var_237,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_237][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_237][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_237][1]).value;
