package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_364.push(new ActorIsOnFurni());
         this.var_364.push(new FurnisHaveAvatars());
         this.var_364.push(new StatesMatch());
         this.var_364.push(new TimeElapsedMore());
         this.var_364.push(new TimeElapsedLess());
      }
