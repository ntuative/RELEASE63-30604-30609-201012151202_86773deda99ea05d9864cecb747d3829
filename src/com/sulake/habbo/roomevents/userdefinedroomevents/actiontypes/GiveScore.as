package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_937:SliderWindowController;
      
      private var var_1112:SliderWindowController;
      ...
      {
         return ActionTypeCodes.var_1858;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_937.getValue());
         _loc2_.push(this.var_1112.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_86 = param2;
         this.var_937 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_937.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_937.setValue(1);
         this.var_1112 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1112.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1112.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_937.setValue(_loc3_);
         this.var_1112.setValue(_loc4_);
      }
