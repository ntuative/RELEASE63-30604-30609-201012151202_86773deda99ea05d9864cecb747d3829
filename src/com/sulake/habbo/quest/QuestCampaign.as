package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_418:Quest;
      
      private var var_257:QuestView;
      ...
      private var var_258:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String, param3:int)
      {
         ...
         this.var_157 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_290)
         {
            ...
            {
               this.var_258.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_290 = null;
            this.var_258.destroyListItems();
            this.var_258.removeListItems();
         }
         this.var_418 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_944 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1185 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_258 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1185.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1185.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_943 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_943)
         {
            this.var_943.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_943.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_943.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_418)
         {
            this.var_418.selected = false;
         }
         if(this.var_157)
         {
            this.var_944.addChild(this.var_157.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1698);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1185.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_290.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_290)
         {
            this.var_258.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_40 || _loc4_.status == QuestStatusEnum.const_463))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_258.maxScrollV > 0)
            {
               this.var_258.scrollV = _loc3_.view.y / this.var_258.maxScrollV;
            }
         }
         else if(this.var_290.length > 0)
         {
            this.activateListItem(this.var_290[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_418 = param1;
         this.var_418.selected = true;
         this.showQuestData(this.var_418);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_257 = new QuestView(this,param1);
         this.var_944.addChild(this.var_257.view);
         this.var_257.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_624.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_624)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_624.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_624.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_290[_loc3_] = _loc5_;
            _loc6_ = this.var_258.getListItemIndex(_loc2_.view);
            this.var_258.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_258.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_258.addListItem(_loc5_.view);
            }
            if(this.var_418 == _loc2_)
            {
