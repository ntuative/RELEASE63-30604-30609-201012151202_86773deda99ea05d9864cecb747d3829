package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_2522:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_110.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_2522 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_110)
         {
            this.var_69.controller.activateQuest(this.var_110);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_69.id,this.var_110.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_69.id,"type_" + this.var_110.type.toLowerCase()].join(".");
         ...
         {
            _loc32_ = this.var_69.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_110.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_69.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1781 = _loc33_.id;
         ...
         {
            case QuestStatusEnum.const_463:
         ...
         this.var_69.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_110.rewardCurrencyAmount.toString());
         ...
         var _loc31_:String = "icon_" + this.var_69.id + "_reward_" + this.var_110.rewardCurrencyAmount;
