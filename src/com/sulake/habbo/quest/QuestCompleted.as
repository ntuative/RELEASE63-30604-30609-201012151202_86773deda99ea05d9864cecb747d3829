package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_186:IFrameWindow;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_186.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
      ...
      {
         this.var_186 = IFrameWindow(this.var_69.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_186.findChildByTag("close").procedure = this.onCompletedDialogClose;
         this.var_186.center();
         var _loc2_:IWindow = this.var_186.findChildByName("button.catalog");
         if(_loc2_)
         {
         ...
         this.var_186.caption = "${quest.completed}";
         this.var_186.findChildByName("reward.description").caption = "${" + _loc3_ + ".completed.reward}";
         ...
         this.var_186.findChildByName("description").caption = this.var_69.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_186.findChildByName("reward.currency.desc").caption = this.var_69.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_69.id + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_186.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
