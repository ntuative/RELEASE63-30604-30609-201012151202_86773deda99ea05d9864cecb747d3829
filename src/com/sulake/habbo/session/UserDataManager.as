package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         return this.getUserDataByType(param1,const_1168);
      }
      
      public function getUserDataByType(param1:int, param2:int) : IUserData
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_667.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_667.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_667.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_667.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         return this.getUserDataByType(param1,const_1167);
      }
