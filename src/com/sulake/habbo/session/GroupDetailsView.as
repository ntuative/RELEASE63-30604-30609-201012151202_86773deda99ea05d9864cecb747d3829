   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(this.var_140 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_140 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_128,HabboWindowStyle.const_34,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
