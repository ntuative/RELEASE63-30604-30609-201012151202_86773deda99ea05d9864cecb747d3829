package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_997:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_997 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_997.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1242));
         this.var_1243.add(this.var_1242,getTimer());
         ++this.var_1242;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1243.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
      ...
      {
         return this.var_997 as IUserDataManager;
      }
