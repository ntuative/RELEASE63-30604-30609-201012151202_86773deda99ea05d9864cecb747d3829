package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.var_146 && param2 >= 0 && param2 < this.var_145)
         {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param4 > this.var_145)
         {
            return false;
         }
         if(param1 + param3 > this.var_146 || param2 + param4 > this.var_145)
         {
            return false;
         }
         ...
         if(param6 < 0 || param6 >= this.var_145)
         {
            param6 = 0;
         }
         ...
         if(param6 + param8 >= this.var_145)
         {
            param8 = this.var_145 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
