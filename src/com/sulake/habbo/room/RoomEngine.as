package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1188:String = "tile_cursor";
      
      private static const const_850:int = -3;
      
      private static const const_1189:String = "selection_arrow";
      
      private static const const_849:String = "overlay";
      ...
      private var var_829:IRoomRendererFactory = null;
      ...
      private var var_678:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_678 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_453.release(new IIDRoomObjectVisualizationFactory());
            this.var_453 = null;
         }
         if(this.var_42 != null)
         {
         ...
         {
            this.var_829.release(new IIDRoomRendererFactory());
            this.var_829 = null;
         }
         ...
         while(_loc2_ < this.var_308.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_95 || _loc6_ != this.var_94 || !this.var_1027)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_583) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_678) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_619) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_723) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_453 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_453;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_42 != null)
         {
            ...
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_277);
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_72);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_829 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_611,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_611)
         {
            this.var_2306 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_282.events.addEventListener(AdEvent.const_491,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_366;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_24 != null)
         {
            ...
            {
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_228,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_411,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_446,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_161,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_791,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_404,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_487,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_414,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_480,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_275,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_435,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_373,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_911,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_540,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_24 == null || this.var_453 == null || this.var_42 == null || this.var_829 == null || this._communication == null || this._habboConfiguration == null || !this.var_2306)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = this.var_307.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1103,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1103);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_464)
         {
            _loc5_ = this.var_307.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_307.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_594,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_936,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_779,1,true);
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_779,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_806,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_583,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_619,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_678,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_723,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_572,param3);
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_763,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_524,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_212);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_649,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_809,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_649,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_809,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_887,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1035,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_851,const_1188,RoomObjectCategoryEnum.const_277);
         _loc7_.createRoomObject(const_850,const_1189,RoomObjectCategoryEnum.const_277);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_311,RoomObjectCategoryEnum.const_72);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_307.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_307.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_572,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_763,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_992,param3);
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_829.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_806);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_649);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_809);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_887);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1035);
      ...
      {
         var _loc8_:int = param2 - this.var_1279;
         var _loc9_:int = param3 - this.var_1281;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1027 = true;
               this.var_830 = false;
               this.var_2304 = this.var_1279;
               this.var_2305 = this.var_1281;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1027)
            {
               if(!this.var_830)
               {
                  _loc8_ = param2 - this.var_2304;
                  _loc9_ = param3 - this.var_2305;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_535,this.var_95,this.var_94,-1,RoomObjectCategoryEnum.const_151));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_849) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_94,this.var_1280);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1279 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1281 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_94,this.var_1280);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_94,this.var_1280);
         if(_loc1_ != null)
         {
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_779) != 0)
         {
            return false;
         }
         if(this.var_68 != null)
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_850,RoomObjectCategoryEnum.const_277);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_851,RoomObjectCategoryEnum.const_277);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_242,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1099,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1077,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_242,_loc10_,false);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_903) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1102);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_524,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_593,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_272,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_639,this.var_95,this.var_94,param2,param3));
            }
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_242));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_474);
                     break;
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_464 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_42.getRoom(const_550);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_42.createRoom(const_550,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_678.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_242,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_474,param8);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
            ...
            case RoomObjectCategoryEnum.const_72:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_300,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_616,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_686,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_757,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_524,_loc24_,param6,new Vector3d(2,0,1.75));
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_95,this.var_94,const_311,RoomObjectCategoryEnum.const_72,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_42.getRoom(const_550);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               this.var_678.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1028.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1091,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_978,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_948,RoomObjectVariableEnum.const_325,param1.clickUrl);
