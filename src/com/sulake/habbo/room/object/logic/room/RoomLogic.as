package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1305:uint = 16777215;
      
      private var var_1659:int = 255;
      
      private var var_1055:uint = 16777215;
      
      private var var_1662:int = 255;
      
      private var var_1056:int = 0;
      
      private var var_1661:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_961,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_645,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_704,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_730,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1056)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1660;
            if(_loc2_ - this.var_1056 >= this.var_1661)
            {
               _loc3_ = this.var_1055;
               _loc4_ = this.var_1662;
               this.var_1056 = 0;
            }
            else
            {
               _loc7_ = this.var_1305 >> 16 & 255;
               _loc8_ = this.var_1305 >> 8 & 255;
               _loc9_ = this.var_1305 & 255;
               _loc10_ = this.var_1055 >> 16 & 255;
               _loc11_ = this.var_1055 >> 8 & 255;
               _loc12_ = this.var_1055 & 255;
               _loc13_ = (_loc2_ - this.var_1056) / this.var_1661;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1659 + (this.var_1662 - this.var_1659) * _loc13_;
               this._color = _loc3_;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_784:
               param2.setString(RoomObjectVariableEnum.const_686,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_524:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_212)
               {
                  _loc5_ = "null";
               }
               this.var_482.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_593:
               _loc4_ = this.var_482.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_482.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1043:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_992:
               param2.setNumber(RoomObjectVariableEnum.const_730,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1305 = this._color;
         this.var_1659 = this.var_1660;
         this.var_1055 = _loc3_;
         this.var_1662 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_508,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1424,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1439,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1350,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_508,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_148 || _loc13_ == RoomPlaneData.const_300)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
