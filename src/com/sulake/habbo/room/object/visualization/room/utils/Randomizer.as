package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_1450:int = 16777216;
      
      private var var_2639:int = 69069;
      
      private var var_2640:int = 5;
      ...
      public static function getValues(param1:int, param2:int, param3:int) : Array
      {
         ...
         return _randomizer.method_9(param1,param2,param3);
      }
      ...
      public function method_9(param1:int, param2:int, param3:int) : Array
      {
         var _loc4_:* = [];
         var _loc5_:int = 0;
         while(_loc5_ < param1)
      ...
      {
         var _loc1_:int = this.var_2639 * this.var_1449 + this.var_2640;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1450;
         this.var_1449 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1450 * param2);
      }
   }
}
