package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1365:int = 16777215;
      
      public static const const_1296:int = 13421772;
      
      private static const const_862:int = 16777215;
      
      private static const const_860:int = 13421772;
      
      private static const const_861:int = 10066329;
      
      private static const const_859:int = 10066329;
      
      public static const const_1269:int = 16777215;
      
      public static const const_1316:int = 13421772;
      
      public static const const_1437:int = 10066329;
      ...
      private var var_704:Rectangle = null;
      
      private var var_482:RoomPlaneBitmapMaskParser = null;
      
      private var var_1595:String = null;
      
      private var _floorType:String = null;
      
      private var var_1596:String = null;
      
      private var var_2459:String = null;
      
      private var var_1105:uint = 16777215;
      
      private var var_2460:int = 255;
      
      private var var_2457:int = 255;
      
      private var var_2458:int = 255;
      ...
      private var var_1256:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_482 = new RoomPlaneBitmapMaskParser();
         this.var_278["null"] = false;
         this.var_278["null"] = true;
         this.var_278["null"] = true;
         this.var_278["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_118 != null)
         {
            ...
            {
               _loc4_ = this.var_118[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_704 = super.boundingRectangle;
         }
         return new Rectangle(this.var_704.x,this.var_704.y,this.var_704.width,this.var_704.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_118.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_118[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_961);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1355)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_111,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc7_)
         {
            ...
            while(_loc9_ < this.var_326.length)
            {
               ...
               _loc12_ = this.var_326[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_93)
               {
                  if(this.var_1729)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2458 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2457 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2460 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1564)
         {
            this.var_1564 = param1.updateId;
            this.var_704 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1256 || _loc3_.y != this.var_2194 || _loc3_.z != this.var_2193 || param1.scale != this.var_2196))
            {
               this.var_1256 = _loc3_.x;
               this.var_2194 = _loc3_.y;
               this.var_2193 = _loc3_.z;
               this.var_2196 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            ...
            if(_loc4_ != this.var_1105)
            {
               this.var_1105 = _loc4_;
               this.var_2458 = this.var_1105 & 255;
               this.var_2457 = this.var_1105 >> 8 & 255;
               this.var_2460 = this.var_1105 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1006));
            if(_loc5_ != this.var_1729)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_686);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_616);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_757);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_704));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_730));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_118[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_278["null"] || param2 != this.var_278["null"] || param3 != this.var_278["null"])
         {
            this.var_278["null"] = param1;
            this.var_278["null"] = param2;
            this.var_278["null"] = param3;
            this.var_326 = [];
            this.var_583 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_326;
         if(this.var_326.length == 0)
         {
            _loc6_ = this.var_118;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_326.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_278[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1666;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_482.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         {
            _loc3_ = this.var_118[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_482.maskCount)
         {
            _loc10_ = this.var_482.getMaskType(_loc8_);
            _loc11_ = this.var_482.getMaskLocation(_loc8_);
            _loc12_ = this.var_482.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_118.length)
               {
                  _loc3_ = this.var_118[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_93)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_93 && _loc12_ == RoomPlaneBitmapMaskData.const_212)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_118[_loc18_] as RoomPlane;
