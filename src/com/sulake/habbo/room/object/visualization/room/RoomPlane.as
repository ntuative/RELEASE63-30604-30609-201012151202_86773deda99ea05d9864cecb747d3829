package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1004:Vector3d = null;
      ...
      private var var_878:IPlaneRasterizer = null;
      
      private var var_626:PlaneMaskManager = null;
      ...
      private var var_394:PlaneBitmapData = null;
      ...
      private var var_203:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_550 = Vector3d.crossProduct(this.var_271,this.var_270);
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_878.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_394;
         if(_loc3_ == null)
         {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_878 != null)
            {
               _loc3_ = this.var_878.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1733,this.var_2472,this.var_2473,this.var_2474,this.var_2471,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1564 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1290.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1290[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1004);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_135.z - originZ,this.var_106.z - originZ,this.var_82.z - originZ,this.var_105.z - originZ);
            if(this._type == const_93)
            {
               relativeDepth += 0.02;
            }
            this.var_2195 = relativeDepth;
            this._isVisible = true;
            this.var_1564 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2470);
      ...
      {
         this.var_135.assign(param1.getScreenPosition(this.var_72));
         this.var_106.assign(param1.getScreenPosition(Vector3d.sum(this.var_72,this.var_270)));
         this.var_82.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_72,this.var_271),this.var_270)));
         this.var_105.assign(param1.getScreenPosition(Vector3d.sum(this.var_72,this.var_271)));
         this._offset = param1.getScreenPoint(this.var_1004);
         ...
         var _loc2_:Number = Math.min(this.var_135.x,this.var_106.x,this.var_82.x,this.var_105.x);
         var _loc3_:Number = Math.max(this.var_135.x,this.var_106.x,this.var_82.x,this.var_105.x);
         var _loc4_:Number = Math.min(this.var_135.y,this.var_106.y,this.var_82.y,this.var_105.y);
         var _loc5_:Number = Math.max(this.var_135.y,this.var_106.y,this.var_82.y,this.var_105.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_135 == null || this.var_106 == null || this.var_82 == null || this.var_105 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         ...
         if(this._type == const_111 || this._type == const_93)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_111 || this._type == const_93))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_880)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_328.length)
            {
               _loc5_ = this.var_328[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_240.length == this.var_879.length)
         {
            while(_loc1_ < this.var_240.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_879[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_328.length > this.var_1357.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_880 || this.var_240.length == 0 && this.var_328.length == 0 && !this.var_329 || this.var_626 == null)
         {
            return;
         }
         ...
         if(this.var_329)
         {
            ...
            while(_loc5_ < this.var_240.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc3_.leftSideLoc / this.var_271.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc3_.rightSideLoc / this.var_270.length;
                  _loc12_ = _loc3_.type;
                  this.var_626.updateMask(this.var_65,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_879.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_328.length)
            {
               _loc4_ = this.var_328[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_65.width - this.var_65.width * _loc4_.leftSideLoc / this.var_271.length;
                  _loc11_ = this.var_65.height - this.var_65.height * _loc4_.rightSideLoc / this.var_270.length;
                  _loc13_ = this.var_65.width * _loc4_.leftSideLength / this.var_271.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_203 != null && (this.var_203.width != param1.width || this.var_203.height != param1.height))
         {
            this.var_203.dispose();
            this.var_203 = null;
         }
         if(this.var_203 == null)
         {
            this.var_203 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_203.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_203.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_203,this.var_203.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
