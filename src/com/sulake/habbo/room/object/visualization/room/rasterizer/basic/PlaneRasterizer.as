package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_543:String = "default";
       
      
      private var var_1179:IGraphicAssetCollection = null;
      
      private var var_331:Map = null;
      
      private var var_177:Map = null;
      
      private var var_118:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_118 != null)
         {
            ...
            {
               _loc2_ = this.var_118.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc3_ = this.var_331.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_331.length)
         {
            _loc2_ = this.var_331.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_331.getValue(param1) as PlaneMaterial;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return this.var_118.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         {
            this.var_118.add(param1,param2);
            return true;
         }
         return false;
      }
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               while(_loc8_ < _loc7_.length())
               {
                  ...
                  this.var_331.add(_loc5_,_loc6_);
                  _loc8_++;
               }
            }
            _loc3_++;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_1179.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
