package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1179:IGraphicAssetCollection;
      
      private var var_1671:XMLList;
      ...
      private var var_768:Boolean = true;
      ...
      private var var_1180:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_767)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1180 = this.var_38.getValue(this.var_767);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_1903 = new Vector3d(-0.5,0.5,0);
         this.var_768 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_1903);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         this.var_938 = param1;
         var _loc3_:LayoutRasterizerData = this.var_38.getValue(this.var_767);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1427 = RoomObjectVariableEnum.const_1091;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1427 = RoomObjectVariableEnum.const_978;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_38.getValue(this.var_767);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_1904 && param3 == this.var_1902)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1427);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1180.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1179.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_350.indexOf(_loc10_) >= 0 && this.var_768)
            {
               param1 = this.var_350.indexOf(_loc10_);
               if(this.var_515[param1] != "")
               {
                  _loc9_ = this.var_1179.getAsset(this.var_515[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_514[param1] != -1)
               {
                  param2.alpha = this.var_514[param1];
               }
               this.var_350.splice(param1,1);
               this.var_515.splice(param1,1);
               this.var_514.splice(param1,1);
      ...
      {
         this.var_768 = true;
         var _loc3_:int = this.var_350.indexOf(param1);
         if(_loc3_ < 0)
         {
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_350.push(param1);
            this.var_515.push("");
            this.var_514.push(param2);
         }
         else
         {
            this.var_514[_loc3_] = param2;
         }
      }
   }
}
