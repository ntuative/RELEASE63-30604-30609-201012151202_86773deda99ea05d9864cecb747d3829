package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_497:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_497 = param1 as AnimatedFurnitureVisualizationData;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_745);
                  this.var_1821 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_745);
                     if(_loc4_ > this.var_1821)
                     {
      ...
      private function resetAnimationFrames() : void
      {
         ...
         this.var_1135 = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1820)
         {
            this.var_498[_loc1_] = null;
            this.var_606[_loc1_] = false;
      ...
      {
         if(this.var_497 != null && this._state >= 0)
         {
            if(this.var_497.hasAnimation(AnimationData.getTransitionAnimationId(param1),this.var_1819))
            {
               if(this.var_1134 != AnimationData.getTransitionAnimationId(param1))
               {
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_1820 = this.var_497.getLayerCount(param1);
            this.resetAnimationFrames();
         }
         var _loc2_:Array = this.updateAnimationFrames(param1);
         if(this.var_1135 && _loc2_ != null && AnimationData.isTransitionAnimation(this.var_1134))
         {
            this.setAnimation(AnimationData.getAnimationId(this.var_1134));
      ...
      private function updateAnimationFrames(param1:Number) : Array
      {
         ...
         if(this.var_563 == 0)
         {
            this.var_563 = this.var_497.getStartFrame(this.animationId,param1);
         }
         this.var_563 += 1;
         var _loc3_:* = null;
         this.var_1135 = true;
         var _loc4_:int = this.var_1820 - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this._animationPlayed[_loc4_];
            if(!_loc5_)
            {
               _loc6_ = this.var_606[_loc4_];
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats >= 0 && _loc9_ <= 0)
               {
                  ...
                  {
                     _loc7_ = this.var_497.getFrame(_loc4_,this.animationId,this.var_563,param1);
                  }
                  else
                  {
                     _loc7_ = this.var_497.getFrameFromSequence(_loc4_,this.animationId,_loc8_,_loc7_.activeSequenceOffset + _loc7_.repeats,this.var_563,param1);
                  }
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats == AnimationFrame.const_468)
               {
                  _loc6_ = true;
                  _loc5_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_498[param1] as AnimationFrame;
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_498[param1] as AnimationFrame;
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
