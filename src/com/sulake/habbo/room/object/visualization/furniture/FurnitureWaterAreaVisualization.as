package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1150:String = "shore";
      ...
      {
         if(this.var_2115 == param1 && this.var_2116 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1150)
            {
               this.var_1526 = _loc2_;
               this.var_2115 = param1;
               this.var_2116 = _direction;
               return this.var_1526;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_993.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_441 + 2;
         var _loc4_:int = this.var_542 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1525 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_370.length)
         {
            if(this.var_370[_loc5_] == true)
            {
               this.var_1525 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_441 == 0 || this.var_542 == 0)
         {
            ...
            this.var_441 = _loc2_.getNumber(RoomObjectVariableEnum.const_279);
            this.var_542 = _loc2_.getNumber(RoomObjectVariableEnum.const_314);
         }
         this.var_370 = [];
         this.var_543 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_441 * 2 + this.var_542 * 2)
         {
            this.var_370.push(false);
            this.var_543.push(ShoreMaskCreatorUtility.const_68);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_441 + 2;
         var _loc2_:int = this.var_542 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_65,getSize(param3),this.var_370,this.var_543,assetCollection);
      }
