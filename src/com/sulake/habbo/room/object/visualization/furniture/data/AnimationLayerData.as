package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_204[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!this.var_1627)
         {
            ...
            {
               _loc2_ = this.var_204[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc7_ = this.var_204.length * Math.random();
         _loc2_ = this.var_204[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = this.var_204[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc9_ = this.var_1734 * _loc8_;
            if(param3)
            {
               _loc9_ = 0;
            }
            _loc10_ = false;
            if(!this.var_1627 && !param2.isRandom)
            {
               if(param4 == this.var_204.length - 1 && param1 == param2.frameCount - 1)
               {
                  _loc10_ = true;
               }
            }
