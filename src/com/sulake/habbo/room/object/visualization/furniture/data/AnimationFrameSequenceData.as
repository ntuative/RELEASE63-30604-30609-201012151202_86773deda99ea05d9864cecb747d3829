package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_379.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_379.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_379[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_379[_loc3_];
               _loc1_ = 1;
            }
            this.var_791[_loc3_] = _loc1_;
            _loc3_--;
         }
      }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_379.push(this._frames.length - 1);
         this.var_791.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         if(this.var_1627)
         {
            param1 = Math.random() * this.var_379.length;
            if(param1 == this.var_379.length)
            {
               param1--;
            }
         }
         param1 = this.var_379[param1 % this.var_379.length];
      ...
      public function getRepeats(param1:int) : int
      {
         ...
         return this.var_791[param1 % this.var_791.length];
      }
   }
}
