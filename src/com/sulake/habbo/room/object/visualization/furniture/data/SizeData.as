package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_364:int = 1000;
      
      public static const const_1330:int = 0;
       
      
      private var var_1820:int = 0;
      
      private var var_1204:int = 360;
      
      private var var_635:DirectionData = null;
      
      private var var_220:Map;
      
      private var _colors:Map;
      
      private var var_954:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_635 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_635,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_635);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_930);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_964);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1204 / 2) % 360 / this.var_1204;
         ...
         {
            _loc6_ = int(this.var_220.getKey(_loc5_)) * this.var_1204;
