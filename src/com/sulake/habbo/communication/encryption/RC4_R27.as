package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1218:int = 52;
      ...
      private static const const_853:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1731:IEncryption;
      
      private var var_2461:PseudoRandom;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(this.var_1731 != null)
         {
            ...
            _loc6_ = this.var_2461.nextInt() % 5;
            ...
            _loc5_ = this.var_1731.encipher(_loc7_,true);
