package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_479:IKeyExchange;
      
      private var var_867:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2438:PseudoRandom;
      ...
      private const const_1562:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_578 = param1;
            this.var_47.initConnection(HabboConnectionType.const_241);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_88,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_47 && this._habboConfiguration && this.var_18 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_578 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1718 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2437 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_201 == null)
         {
            this.var_201 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_47.mode = HabboConnectionType.const_113;
            if(this.var_578)
            {
               this.var_47.initConnection(HabboConnectionType.const_241);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_443,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_949;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_241);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_748);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2438 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_113:
               ...
               this.var_201.loadBannerImage(_loc7_ + "?token=" + this.var_1344,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_949:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1278:
               this.var_867 = this.generateRandomHexString(30);
               this.var_479 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_479.init(this.var_867);
               _loc8_ = this.var_479.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_479.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_479.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2438);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1718,this.var_2437));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1562,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_578 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_578);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_180);
         }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2436)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_479 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_479.init(_loc14_);
            _loc15_ = this.var_479.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_867 = _loc14_;
            }
