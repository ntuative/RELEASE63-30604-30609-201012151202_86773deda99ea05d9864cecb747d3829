package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_829:int = 60;
      
      private static const const_831:int = 3600;
      
      private static const const_830:int = 86400;
      
      private static const const_828:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_829) + " mins ago";
         }
         if(param1 < 2 * const_830)
         {
            return Math.round(param1 / const_831) + " hours ago";
         }
         if(param1 < 2 * const_828)
         {
            return Math.round(param1 / const_830) + " days ago";
         }
         return Math.round(param1 / const_828) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_967.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_46.getXmlWindow("user_info"));
            this.var_967.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_46,WindowTracker.const_1042,this._data.userId),this._callerFrame,this.var_966,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new RoomVisitsCtrl(this.var_46,this._data.userId),this._callerFrame,this.var_966,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new SendMsgsCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1350),this._callerFrame,this.var_966,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ModActionCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1350),this._callerFrame,this.var_966,false,true);
      }
