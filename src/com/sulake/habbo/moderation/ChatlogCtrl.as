package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1583:IMessageComposer;
      ...
      {
         this.var_986 = IWindowContainer(this.var_46.getXmlWindow("chatlog_roomheader"));
         this.var_985 = IWindowContainer(this.var_46.getXmlWindow("chatlog_chatline"));
         ...
         this.var_46.connection.send(this.var_1583);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_986.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_985.clone());
         _loc4_.color = this.var_1517[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
