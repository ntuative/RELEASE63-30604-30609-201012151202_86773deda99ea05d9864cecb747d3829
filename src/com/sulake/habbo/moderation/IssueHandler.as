package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_121.getHighestPriorityIssue();
         this.var_452 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_1005 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_452.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_121.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_121.reportedUserId > 0)
         {
            this.var_1005.load(_loc4_,this.var_121.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_121.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = this.var_121.issues;
         var _loc5_:int = 0;
      ...
      {
         if(this.var_59 != null && this.var_59.issueManager != null && this.var_121 != null)
         {
            this.var_59.issueManager.removeHandler(this.var_121.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_121.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_121.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_121.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.releaseBundle(this.var_121.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_121.getHighestPriorityIssue().issueId;
         this.var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_59,WindowTracker.const_976,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_121.getHighestPriorityIssue();
            this.var_452 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
            this.var_452.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
