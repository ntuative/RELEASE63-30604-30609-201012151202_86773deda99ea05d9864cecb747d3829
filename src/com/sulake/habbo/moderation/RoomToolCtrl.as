package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_806:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_46.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_309));
         Logger.log("BEGINNING TO SHOW: " + this.var_309);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_309);
         if(param1.flatId != this.var_309)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_309);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_806 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_46,WindowTracker.const_612,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_806.isSelected);
         this.var_46.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1327,_loc2_,this.var_480.text,"",""));
         if(this.var_1247.isSelected || this.var_1246.isSelected || this.var_806.isSelected)
         {
            this.var_46.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1247.isSelected,this.var_1246.isSelected,this.var_806.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_46.initMsg.roomMessageTemplates[this.var_955.selection];
         if(_loc3_ != null)
         {
            this.var_559 = false;
