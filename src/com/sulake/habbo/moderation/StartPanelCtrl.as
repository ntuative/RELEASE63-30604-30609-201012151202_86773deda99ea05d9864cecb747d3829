package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1505 ? 0 : 1,this._roomId),this.var_46,WindowTracker.const_612,this._roomId),this._frame,false,false,true);
      }
