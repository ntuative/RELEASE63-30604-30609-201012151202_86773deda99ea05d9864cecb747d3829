package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_1964 = IWindowContainer(this.var_46.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1377;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_1964.clone());
