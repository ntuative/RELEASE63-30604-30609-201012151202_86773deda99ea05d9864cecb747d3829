package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1845:String = "open_issues";
      
      private const const_1843:String = "picked_issues";
      ...
      private var var_1743:IIssueBrowserView;
      
      private var var_1744:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_333.view.width = this.var_241.container.width;
         this.var_333.view.height = this.var_241.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1844:
               ...
               {
                  this.var_1742 = new MyIssuesView(this.issueManager,this,this.var_241.container);
               }
               return this.var_1742;
            case this.const_1845:
               if(this.var_1743 == null)
               {
                  this.var_1743 = new OpenIssuesView(this.issueManager,this,this.var_241.container);
               }
               return this.var_1743;
            case this.const_1843:
               if(this.var_1744 == null)
               {
                  this.var_1744 = new PickedIssuesView(this.issueManager,this,this.var_241.container);
               }
