package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_1152:Number = 0.0;
      
      private var var_750:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_675,RoomWidgetChatSelectAvatarMessage.const_601];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_675:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":furni":
                              ...
                              return null;
                           case ":pickall":
                              this._container.sessionDataManager.method_7(this._container.roomSession.roomId,this._container.roomSession.roomCategory);
                              return null;
                           case ":news":
                              if(false)
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_601:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_249)
                           {
                           ...
                           _loc12_ = uint(this.var_926.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_249:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_79,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_79,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_249)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_405.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_404.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_926.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1152 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1152);
            }
            if(this.var_750 == null)
            {
               ...
               this.var_500.y = 0;
               this.var_500.z = 0;
               this.var_750 = _loc4_.getScreenPoint(this.var_500);
               this.var_1152 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_500.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_750.x || _loc8_.y != this.var_750.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_750,_loc5_));
