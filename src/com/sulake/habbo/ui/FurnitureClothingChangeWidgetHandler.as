package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1248:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1247:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_642,RoomWidgetClothingChangeMessage.const_338,RoomWidgetAvatarEditorMessage.const_323];
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetClothingChangeMessage.const_338:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_325 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_890);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1248;
                     }
                     ...
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_207,AvatarEditorFigureCategory.const_618],true))
                     {
                        _loc11_ = 0;
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_325,param2,param1);
