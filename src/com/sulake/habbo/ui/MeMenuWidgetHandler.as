   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_783,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_531,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_783,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_167,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1045,this.onAvatarEffectsChanged);
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_531,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1191)
            {
               ...
               this.var_1446 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1446;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1113,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_596);
         _loc1_.push(RoomWidgetDanceMessage.const_676);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_571);
         _loc1_.push(RoomWidgetStopEffectMessage.const_724);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1380);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1002);
         _loc1_.push(RoomWidgetToolbarMessage.const_807);
         _loc1_.push(RoomWidgetToolbarMessage.const_635);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_323);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1282);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_923);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_666);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_706);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_766);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1271);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_792);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_749);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_741);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_338);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_706:
               ...
               break;
            case RoomWidgetWaveMessage.const_596:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_676:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_813:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_571:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1105:
                        this._catalog.openCatalogPage(CatalogPageName.const_1357,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_980:
            ...
            case RoomWidgetStopEffectMessage.const_724:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_666:
               ...
               break;
            case RoomWidgetToolbarMessage.const_807:
            ...
            case RoomWidgetToolbarMessage.const_635:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_462,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_323:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_442));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_766:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_356,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_792:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_356,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_749:
            ...
            case RoomWidgetAvatarEditorMessage.const_741:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_338:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_581));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_109:
               ...
               break;
            case HabboHelpTutorialEvent.const_531:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_422));
         }
      }
