package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1212:IEventDispatcher;
      
      private var var_964:Boolean = false;
      
      private var var_1488:ProfilerOutput;
      
      private var var_1213:ProfilerAgentTask;
      
      private var var_1211:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_783 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_783);
         this.var_174 = new Array(const_385);
         ...
         {
            this.var_174[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_238 = this.var_174[const_1139];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_238.getMouseCursor().defineCustomCursorType(MouseCursorType.const_377,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_238.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1436,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1488)
            {
               this.var_1488 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1488.profiler = _loc3_;
            this.var_1213 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1213);
            this.var_1211 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1211);
            this.var_964 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_174)
            {
               while(this.var_174.length > 0)
               {
                  IDisposable(this.var_174.pop()).dispose();
               }
            }
            this.var_174 = null;
            if(this.var_294)
      ...
      {
         return this.var_238.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_238.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_783.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_174[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_174[param2].getDesktopWindow();
      ...
      {
         return this.var_174[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_174[param1].getDesktopWindow().getChildAt(this.var_238.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_174[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1212.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_385 - 1;
            while(_loc2_ >= 0)
            {
               this.var_174[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_964)
         ...
         this.var_1212.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_385)
         {
            this.var_174[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_964)
         {
         ...
         this.var_1212.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1516,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1405,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1283,param2.name + ": " + param2.toString());
            }
         }
      }
   }
