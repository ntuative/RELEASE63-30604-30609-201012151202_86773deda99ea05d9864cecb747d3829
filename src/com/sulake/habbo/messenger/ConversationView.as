package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1190:int = 10;
      
      private static const const_852:int = 100;
      ...
      private var var_2314:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_126 = param1;
         this.var_1613 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_53 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2314 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_852 + const_1191)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1190;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1613.enable();
         }
         else
         {
            this.var_1613.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_53.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_465.messages.length - const_852);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_707 || param3.type == Message.const_720 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_126.send(new FollowFriendMessageComposer(this.var_465.id));
      }
