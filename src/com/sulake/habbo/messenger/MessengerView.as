package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_770:ITextFieldWindow;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_17 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_126.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MESSENGER,this.var_17));
         }
         else
         {
            this.refresh();
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1188.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_769 = new ConversationsTabView(this.var_126,this.var_17);
         this.var_769.refresh();
         this.var_770 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_770.addEventListener(WindowKeyboardEvent.const_143,this.onMessageInput);
         this.var_1188 = new ConversationView(this.var_126,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_733,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_959,true);
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_770.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_770.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_770.text;
         ...
         this.var_770.text = "";
         this.var_126.conversations.addMessageAndUpdateView(new Message(Message.const_707,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
