package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1522:uint = 1;
      
      protected static const const_1520:uint = 2;
      
      protected static const const_1519:uint = 4;
      
      protected static const const_1521:uint = 3;
      ...
      private static var var_793:Array = new Array();
      ...
      protected var var_2621:String = "";
      
      protected var var_2620:String = "";
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1086)
         {
            ...
            while(var_652.length < const_1286 && false)
            {
               _loc1_ = var_793.shift() as LibraryLoader;
      ...
      {
         return !!this.var_933 ? uint(this.var_1161 - this.var_1881) : uint(getTimer() - this.var_1881);
      }
      ...
      {
         if(this.var_932 && !_disposed)
         {
            this.var_932 = false;
            if(!this.var_933 && this.var_214)
            {
               this.var_1161 = -1;
      ...
      {
         if(!this.var_933 && !_disposed && this.var_1160 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_214,const_1481 - this.var_1160);
            if(this.var_2622)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_411 == LibraryLoader.const_1521)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_558 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_558.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_671 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
