package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_931 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_36 = new Loader();
         this.var_930 = new LoaderContext();
         this.var_930.checkPolicyFile = true;
         ...
         {
            this.var_36.load(param2,this.var_930);
         }
      }
      ...
      {
         this.var_931 = param1.url;
         var_286 = 0;
         this.var_36.load(param1,this.var_930);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_286 < var_2615)
            {
               ...
               this.var_36.load(new URLRequest(this.var_931 + (this.var_931.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_286),this.var_930);
               return true;
            }
         }
         return false;
