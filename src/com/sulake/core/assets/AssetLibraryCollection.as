package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_930:LoaderContext;
      
      protected var var_410:AssetLibrary;
      
      protected var var_671:XML;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_930 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_410 = new AssetLibrary("lib-" + this.var_512++);
         this.var_28.push(this.var_410);
      }
      ...
      {
         return this.var_410.loadFromResource(param1,param2);
      }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_503.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_503.length)
            {
               _loc3_ = this.var_503[_loc4_] as IAssetLibrary;
      ...
      {
         return this.var_410.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_410.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_410.createAsset(param1,param2);
      }
      ...
      {
         return this.var_410.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_410.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_410.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_410.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
