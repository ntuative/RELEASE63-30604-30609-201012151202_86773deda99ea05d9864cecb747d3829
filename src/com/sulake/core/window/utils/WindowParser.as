package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1029:String = "_EXCLUDE";
      
      public static const const_1616:String = "_INCLUDE";
      
      public static const const_1652:String = "_TEMP";
      
      private static const const_1202:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1203:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_935,this.var_1422);
         this.var_1891 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1203,"");
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1029) == -1)
                  {
