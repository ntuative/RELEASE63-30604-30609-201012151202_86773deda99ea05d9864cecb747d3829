package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_759:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_78 = param1.var_1156 as WindowController;
         this._lastClickTarget = param1.var_1155 as WindowController;
         this.var_147 = param1.renderer;
         this.var_759 = param1.var_1153;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_617.x || _loc3_.stageY != this.var_617.y)
            {
               this.var_617.x = _loc3_.stageX;
               this.var_617.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_617,_loc6_,WindowParam.const_28);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_78 && !this.var_78.disposed)
                     {
                        ...
                        {
                           this.var_759.mouseEventReceived(_loc3_.type,this.var_78);
                        }
                     }
                  }
         ...
         param1.var_1156 = this.var_78;
         param1.var_1155 = this._lastClickTarget;
         param1.renderer = this.var_147;
         param1.var_1153 = this.var_759;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_464))
         {
