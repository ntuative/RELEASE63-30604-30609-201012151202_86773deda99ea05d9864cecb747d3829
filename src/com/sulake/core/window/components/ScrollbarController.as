package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1250:String = "increment";
      
      private static const const_1249:String = "decrement";
      
      private static const const_880:String = "slider_track";
      
      private static const const_560:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_620:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_149 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_419;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_20 != null && !this.var_20.disposed)
         {
            ...
            this.var_20.removeEventListener(WindowEvent.const_447,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_447,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_911 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_880) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_560) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_560:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_281)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_620;
                  }
                  else
                  {
                     this.scrollV -= this.var_620;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_400)
         {
            if(param2.name == const_1250)
            {
               if(this.var_20)
               {
                  this.var_1137 = true;
            ...
            else if(param2.name == const_1249)
            {
               if(this.var_20)
               {
                  this.var_1137 = true;
            ...
            else if(param2.name == const_880)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_560).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_911) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_911) as IScrollableWindow;
               if(_loc1_)
               {
