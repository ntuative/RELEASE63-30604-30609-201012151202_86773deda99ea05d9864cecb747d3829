package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1117:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1524:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      ...
      private var var_372:String = "regular";
      
      private var var_189:TextStyle;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_372,this.var_189);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_189.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_189.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_189.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_189.fontSize = param2;
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_189.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_189.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_372 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_372,param1.var_189);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_189.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_355);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_906 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_372);
      }
      ...
      {
         return new Rectangle(this.var_760 * this.maxScrollH,this.var_506 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_372);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_260,this.defaultTextFormat.size != _loc2_.fontSize));
         ...
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_87,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1524));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_87,this._field.gridFitType != GridFitType.PIXEL,const_1525));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_203,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_372,PropertyStruct.const_87,this.var_372 != TextStyleManager.const_355,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_203,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_50,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_79.left,PropertyStruct.const_52,this.var_79.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_79.top,PropertyStruct.const_52,this.var_79.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_79.right,PropertyStruct.const_52,this.var_79.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_79.bottom,PropertyStruct.const_52,this.var_79.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_412,PropertyStruct.const_87,this.var_412 != TextFieldAutoSize.NONE,const_1526));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_203,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
