package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1148:IItemListWindow;
      
      private var var_402:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_402)
         {
            this.var_402.removeEventListener(WindowEvent.const_271,this.scrollBarEventProc);
            this.var_402.removeEventListener(WindowEvent.const_256,this.scrollBarEventProc);
            this.var_402 = null;
         }
         if(this.var_1148)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1148)
         {
            this.var_1148 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_402)
         {
            this.var_402 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_402)
            {
               this.var_402.addEventListener(WindowEvent.const_271,this.scrollBarEventProc);
               this.var_402.addEventListener(WindowEvent.const_256,this.scrollBarEventProc);
            }
         }
         return this.var_402;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_256)
         {
            this.hideScrollBar();
         }
      }
