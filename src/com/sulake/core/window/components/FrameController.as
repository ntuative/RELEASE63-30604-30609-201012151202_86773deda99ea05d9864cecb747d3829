package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1181:String = "_HEADER";
      
      private static const const_1180:String = "_CONTENT";
      
      private static const const_1182:String = "_SCALER";
      
      private static const const_847:String = "margin_left";
      
      private static const const_844:String = "margin_top";
      
      private static const const_846:String = "margin_right";
      
      private static const const_845:String = "margin_bottom";
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1259 = findChildByTag(const_1181) as IHeaderWindow;
            if(!this.var_1259)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_163 = findChildByTag(const_1180) as IWindowContainer;
            if(!this.var_163)
            {
      ...
      {
         return findChildByTag(const_1182) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1120,_loc2_,false);
      ...
      {
         return this.content != null && this.var_933 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_847,_loc3_.left,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_844,_loc3_.top,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_846,0 - _loc3_.right,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_845,0 - _loc3_.bottom,PropertyStruct.const_52,_loc2_));
         return _loc1_;
      }
