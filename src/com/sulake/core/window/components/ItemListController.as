package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1121:String = "resize_on_item_update";
      
      protected static const const_1124:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1531:Boolean = false;
      ...
      protected var var_2676:Number = 0.0;
      
      protected var var_2677:Number = 0.0;
      ...
      protected var var_1899:int = 0;
      
      protected var var_1901:int = 0;
      
      protected var var_1172:Number;
      
      protected var var_1174:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_99 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_344;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_149 = var_406 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_375,WindowStyle.const_728,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_44,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_537,this.containerEventHandler);
         ...
         this.resizeOnItemUpdate = this.var_1173;
      }
      ...
      {
         return new Rectangle(this.var_621 * this.maxScrollH,this.var_622 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_621 = param1;
            this._container.x = -this.var_621 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_447,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_622 = param1;
            this._container.y = -this.var_622 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_447,this,null));
         }
      }
      ...
      {
         this.var_2676 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2677 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_394,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_537,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_187:
               if(this.var_1171)
               {
                  this.var_1172 = this.var_1899 - _loc3_;
                  this.var_1174 = this.var_1901 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1172 != 0 && this.var_99 != 0)
                     {
                        this.scrollH += this.var_1172 / this.var_99;
                     }
                  }
                  else if(this.var_1174 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1174 / this.var_90;
                  }
                  this.var_1899 = _loc3_;
                  this.var_1901 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_171:
               if(this.var_1171)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1172,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1174);
                  }
                  this.var_1171 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_936 && !this.var_510 && this._container)
         {
            this.var_510 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1124,this.var_936,PropertyStruct.const_50,this.var_936 != const_1530));
         _loc1_.push(new PropertyStruct(const_1122,this.var_511,PropertyStruct.const_50,this.var_511 != const_1531));
         _loc1_.push(new PropertyStruct(const_1121,this.var_1173,PropertyStruct.const_50,this.var_1173 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
