package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1176:Boolean = false;
      ...
      {
         this.var_1170 = param1 == null ? "" : param1;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_365,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1176,PropertyStruct.const_50,this.var_1176 != false));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_1176 = _loc2_.value as Boolean;
               if(this.var_1176)
               {
