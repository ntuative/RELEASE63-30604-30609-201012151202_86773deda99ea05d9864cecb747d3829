package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_154 == null || this.var_154.disposed)
         {
            this.var_154 = context.create(name + "::submenu","",WindowType.const_460,var_77,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_788 = false;
            this.getTitleText().text = this.var_534 < this._itemArray.length && this.var_534 > -1 ? this._itemArray[this.var_534] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_415,var_77,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_375,var_77,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_534 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_534).setStateFlag(WindowState.const_47,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1028:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_599:
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1115,this._itemArray,PropertyStruct.const_142,this._itemArray.length > 0));
         return _loc1_;
      }
