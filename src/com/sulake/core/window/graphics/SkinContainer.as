package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_874:uint = 8;
      
      private static const const_1241:String = "skin";
      
      private static const const_1240:String = "bitmap";
      
      private static const const_1243:String = "fill";
      
      private static const const_1242:String = "text";
      
      private static const const_1244:String = "shape";
      
      private static const const_1239:String = "unknown";
      
      private static const const_1238:String = "null";
      ...
      private var var_2541:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1794,this.var_2540);
         this.var_2541 = new Dictionary();
         this.var_2542 = new Dictionary();
         StateCodeTable.fillTables(this.var_2541,this.var_2542);
         this.var_495 = new Dictionary();
         this.var_495[const_1241] = BitmapSkinRenderer;
         this.var_495[const_1240] = BitmapDataRenderer;
         this.var_495[const_1243] = FillSkinRenderer;
         this.var_495[const_1242] = TextSkinRenderer;
         this.var_495[const_1244] = ShapeSkinRenderer;
         this.var_495[const_1239] = SkinRenderer;
         this.var_495[const_1238] = NullSkinRenderer;
         if(var_289 == null)
         {
            var_289 = new Array();
            var_289.push(WindowState.const_66);
            var_289.push(WindowState.const_67);
            var_289.push(WindowState.const_83);
            var_289.push(WindowState.const_47);
            var_289.push(WindowState.WINDOW_STATE_HOVERING);
            var_289.push(WindowState.const_77);
            var_289.push(WindowState.const_97);
            var_289.push(WindowState.const_91);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1794[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_901[param1] = new Array(const_874);
         }
         this.var_901[param1][param2] = param3;
         if(this.var_902[param1] == null)
         {
            this.var_902[param1] = new Array(const_874);
         }
         this.var_902[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_266)
            {
               _loc4_ = _loc3_["null"];
            }
         }
