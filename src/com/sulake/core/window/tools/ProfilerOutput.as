package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1414:Class = ProfilerOutput_profiler_task_xml;
      ...
      {
         var _loc2_:ByteArray = new var_1414() as ByteArray;
