package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_584:Number = 64;
      
      public static const const_1110:Number = 32;
      ...
      private var var_363:Number = 1.0;
      
      private var var_362:Number = 1.0;
      
      private var var_1480:Number = 1.0;
      
      private var var_1481:Number = 1.0;
      
      private var var_1479:Number = 1.0;
      
      private var var_72:Vector3d;
      
      private var var_221:Vector3d;
      
      private var var_2643:Number = -500.0;
      
      private var var_2642:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_960 = new Vector3d();
         this.var_1480 = 1;
         this.var_1481 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1479 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_150.x,this.var_150.y,this.var_150.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_72.x * this.var_361,this.var_72.y * this.var_363,this.var_72.z * this.var_362);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_221.x,this.var_221.y,this.var_221.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_361 != param1 * this.var_1480)
         {
            this.var_361 = param1 * this.var_1480;
            ++this.var_132;
         }
      }
      ...
      {
         if(this.var_363 != param1 * this.var_1481)
         {
            this.var_363 = param1 * this.var_1481;
            ++this.var_132;
         }
      }
      ...
      {
         if(this.var_362 != param1 * this.var_1479)
         {
            this.var_362 = param1 * this.var_1479;
            ++this.var_132;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_72.y /= this.var_363;
         this.var_72.z /= this.var_362;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         {
            this.var_221 = new Vector3d();
         }
         var _loc2_:Number = this.var_221.x;
         var _loc3_:Number = this.var_221.y;
         var _loc4_:Number = this.var_221.z;
         this.var_221.assign(param1);
         if(this.var_221.x != _loc2_ || this.var_221.y != _loc3_ || this.var_221.z != _loc4_)
         {
            ++this.var_132;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_150.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_151.assign(_loc19_);
            this.var_150.assign(_loc20_);
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_433 != null)
         {
            ...
            return this.var_433.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_960.assign(_loc22_);
         }
         else
         {
            this.var_960.assign(_loc17_);
         }
         ++this.var_132;
      }
      ...
      {
         if(param1 == null || this.var_150 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_150,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_150);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_363;
         _loc2_.z *= this.var_362;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_960);
         if(_loc3_ < this.var_2643 || _loc3_ > this.var_2642)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_363;
            _loc2_.z *= this.var_362;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_960);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_151,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_72.x * this.var_361,this.var_72.y * this.var_363,this.var_72.z * this.var_362);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_150;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_361,param2.y * this.var_363,param2.z * this.var_362);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_361,param3.y * this.var_363,param3.z * this.var_362);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_361,param4.y * this.var_363,param4.z * this.var_362);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1110;
         }
         else
         {
            this.scale = const_584;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_584;
      }
