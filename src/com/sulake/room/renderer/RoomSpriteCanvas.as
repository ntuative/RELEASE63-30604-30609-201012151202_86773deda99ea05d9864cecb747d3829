package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1533:int = 50;
      ...
      private var var_424:Point;
      
      private var var_217:BitmapDataCache;
      
      private var var_521:RoomObjectCache;
      
      private var var_425:Array;
      
      private var var_524:Array;
      
      private var var_1190:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_1925:Number = -1.0E7;
      
      private var var_1922:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_218.addChild(this.var_52);
         ...
         this.var_217 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_521 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_424.x -= param1 - this.var_520;
         this.var_520 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_424.y -= param1 - this.var_522;
         this.var_522 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_880 = true;
            if(this.var_115 != null && !this.var_218.contains(this.var_115))
            {
               this.var_218.addChild(this.var_115);
               this.var_52.mask = this.var_115;
            }
         }
         else if(!param1 && this.var_880)
         {
            ...
            if(this.var_115 != null && this.var_218.contains(this.var_115))
            {
               this.var_218.removeChild(this.var_115);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_524.length)
            {
               this.cleanSprite(this.var_524[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_524 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_115 != null)
         {
            this.var_115.graphics.clear();
         }
         else
         {
            this.var_115 = new Sprite();
            this.var_115.name = "mask";
            if(this.var_880)
            {
               this.var_218.addChild(this.var_115);
               this.var_52.mask = this.var_115;
         ...
         this.var_115.graphics.beginFill(0);
         this.var_115.graphics.drawRect(0,0,param1,param2);
         this.var_630 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_521.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_630 != this.var_1924 || this._ht != this.var_1926)
         {
            _loc9_ = true;
         }
         if(this.var_52.x != this.var_520 || this.var_52.y != this.var_522)
         {
            this.var_52.x = this.var_520;
            this.var_52.y = this.var_522;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_425.sortOn("z",0 | 0);
         if(_loc5_ < this.var_425.length)
         {
            this.var_425.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_425[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_1924 = this.var_630;
         this.var_1926 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_521.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_521.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_520;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_522;
                  if(_loc19_ < this.var_630 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_425.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_520;
                     _loc17_.y = _loc20_ - this.var_522;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_524.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_629 || this.var_629 == 0)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_425[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_217.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_217.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_217.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_217.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_520;
         param2 -= this.var_522;
         this.var_424.x = param1;
         this.var_424.y = param2;
         if(this.var_949 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1439;
         }
         this.var_1439 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_949;
         return this.var_1439;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1440,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_523.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_523.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_1925 || param2 != this.var_1922)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_523.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_523.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_291.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_291 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_291.getKey(_loc1_);
            _loc3_ = this.var_291.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1190.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_949 == 0)
         {
            this.checkMouseHits(this.var_424.x,this.var_424.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_949 = 0;
         ++this.var_1440;
      }
